...
public partial class JibeWebService
{
    ...
    [WebMethod]
    public List<Rank> Get_Rank()
    {


        SMS.Business.Crew.BLL_Crew_Admin objRank = new SMS.Business.Crew.BLL_Crew_Admin();

        Ranks = new List<Rank>();
        DataTable dt = objRank.Get_RankList();
                ...
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dr in dt.Rows)
                    {
                        Ranks.Add(new Rank()
                        {
                            ...
                            ID = Convert.ToInt32(dr["ID"].ToString()),
                            RANK_NAME = dr["Rank_Name"].ToString(),
          ...
          , string dept, string vesselid, string functionid, string accountcode, int? AddSubSysFlag, string SerialNumber, int IsLocationRequired, int Run_Hour, int Critical, string DeptType)
    {
        ...
        return objLibCat.PMS_Insert_NewSystem(userid, systemcode, systemdesc, stystemparticular, maker, setinstalled, model, dept, vesselid, functionid, accountcode, AddSubSysFlag, SerialNumber, IsLocationRequired, Run_Hour, Critical, DeptType);
    }
    [WebMethod]
    ...
    /// <summary>
    /// To get open observation tooltip
    /// </summary>
    /// <param name="Vetting_ID">Id of vetting</param>
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_OpenObservationTooltip(int? Vetting_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();

        Dictionary<string, UDCHyperLink> dicLink = new Dictionary<string, UDCHyperLink>();
        List<UDCAction> dicAction = new List<UDCAction>();

        List<UDCJSEvent> dicJSEvent = new List<UDCJSEvent>();
        dicJSEvent.Add(new UDCJSEvent(new string[][] { new string[] { "AddNote_Observation", "onclick" } }, new string[] { "Question_ID", "Observation_ID", "Vetting_ID", "ObservationCount", "FleetCode", "Vetting_Type_ID", "Vessel_ID" }, "Question_No"));

        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_OpenObservationTooltip(Vetting_ID),
           new string[] { "No", "Observation" },
           new string[] { "Question_No", "Opn_Observation" },
           dicLink,
            new Dictionary<string, UDCToolTip>(),
           new string[] { "left", "left" },
           "CreateHtmlTableFromDataTable-table",
           "CreateHtmlTableFromDataTable-DataHedaer",
           "CreateHtmlTableFromDataTable-Data", "CreateHtmlTableFromDataTable-Data", dicAction, dicJSEvent);
    }
    /// <summary>
    /// To get closed observation tooltip
    /// </summary>
    /// <param name="Vetting_ID">Id of vetting</param>
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_CloseObservationTooltip(int? Vetting_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();

        Dictionary<string, UDCHyperLink> dicLink = new Dictionary<string, UDCHyperLink>();
        //UDCHyperLink lnk = new UDCHyperLink("", "../Vetting/Vetting_AddObservationNotes.aspx", new string[] { "Question_ID", "Observation_ID", "Vetting_ID", }, new string[] { "Question_ID", "Observation_ID", "Vetting_ID" }, "");
        //dicLink.Add("Question_No", lnk);
        List<UDCAction> dicAction = new List<UDCAction>();
        List<UDCJSEvent> dicJSEvent = new List<UDCJSEvent>();
        dicJSEvent.Add(new UDCJSEvent(new string[][] { new string[] { "AddNote_Observation", "onclick" } }, new string[] { "Question_ID", "Observation_ID", "Vetting_ID", "ObservationCount", "FleetCode", "Vetting_Type_ID", "Vessel_ID"}, "Question_No"));

        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_CloseObservationTooltip(Vetting_ID),
           new string[] { "No", "Observation" },
           new string[] { "Question_No", "Closed_Observation" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
           new string[] { "left", "left" },
           "CreateHtmlTableFromDataTable-table",
    ...
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_NoteTooltip(int? Vetting_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();
        ...
        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_NoteTooltip(Vetting_ID),
           new string[] { "No", "Notes" },
           new string[] { "Question_No", "Note" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
           new string[] { "left", "left" },
          "CreateHtmlTableFromDataTable-table",
    ...
    /// <summary>
    /// To get pending job tooltip
    /// </summary>
    /// <param name="Vetting_ID">Id of vetting</param>
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_PendingJobsTooltip(int? Vetting_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();

        Dictionary<string, UDCHyperLink> dicLink = new Dictionary<string, UDCHyperLink>();
        UDCHyperLink lnk = new UDCHyperLink("", "../Worklist/ViewJob.aspx", new string[] { "Vetting_ID", "WLID", "OFFID", "VID" }, new string[] { "Vetting_ID", "ID", "Office_ID", "Vessel_ID" }, "");
        dicLink.Add("Job_card_No", lnk);

        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_PendingJobsTooltip(Vetting_ID),
           new string[] { "Code", "Description" },
           new string[] { "Job_card_No", "Job_Description" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
           new string[] { "left", "left" },
          "CreateHtmlTableFromDataTable-table",
    ...
    /// <param name="Observation_ID"></param>
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_OBSWisePendingJobsTooltip(int? Vetting_ID, int? Question_ID, int? Observation_ID)
    {
        SMS.Business.VET.BLL_VET_Planner objBl = new SMS.Business.VET.BLL_VET_Planner();

        Dictionary<string, UDCHyperLink> dicLink = new Dictionary<string, UDCHyperLink>();
        UDCHyperLink lnk = new UDCHyperLink("", "../Worklist/ViewJob.aspx", new string[] { "Vetting_ID", "WLID", "OFFID", "VID" }, new string[] { "Vetting_ID", "ID", "Office_ID", "Vessel_ID" }, "");
        dicLink.Add("Job_card_No", lnk);

        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_PendingJobsTooltip(Vetting_ID, Question_ID, Observation_ID),
           new string[] { "Code", "Description" },
           new string[] { "Job_card_No", "Job_Description" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
    ...
    [WebMethod]
    public string VET_Get_QuestionForTooltip(int? Questionnaire_ID, int? SectionNo, int? Question_ID)
    {
        SMS.Business.VET.BLL_VET_Planner objBl = new SMS.Business.VET.BLL_VET_Planner();

        Dictionary<string, UDCHyperLink> dicLink = new Dictionary<string, UDCHyperLink>();

        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_QuestionForToolTip(Questionnaire_ID, SectionNo, Question_ID),
           new string[] { "Number", "Description" },
           new string[] { "Question_No", "Question" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
           new string[] { "left", "left" },
          "CreateHtmlTableFromDataTable-table",
    ...
    /// <summary>
    /// To get observationIndex Related jobs tooltip
    /// </summary>
    /// <param name="Question_ID">Id of vetting</param>
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_ObsIndxRelatedJobsTooltip(int? Question_ID, int? Observation_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();
        ...
        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_ObsIndxRelatedJobsTooltip(Question_ID, Observation_ID),
           new string[] { "Code", "Status", "Description" },
           new string[] { "Job_card_No", "Job_Status", "Job_Description" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
           new string[] { "left", "left", "left" },
          "CreateHtmlTableFromDataTable-table",
    ...
    /// <summary>
    /// To get completed job tooltip
    /// </summary>
    /// <param name="Vetting_ID">Id of vetting</param>
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_CompletedJobsTooltip(int? Vetting_ID, int? Question_ID, int? Observation_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();
        ...
        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_CompletedJobsTooltip(Vetting_ID, Question_ID, Observation_ID),
           new string[] { "Code", "Description" },
           new string[] { "Job_card_No", "Job_Description" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
    ...
    /// <summary>
    /// To get verified job tooltip
    /// </summary>
    /// <param name="Vetting_ID">Id of vetting</param>
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_VerifiedJobsTooltip(int? Vetting_ID, int? Question_ID, int? Observation_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();
        ...
        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_VerifiedJobsTooltip(Vetting_ID, Question_ID, Observation_ID),
           new string[] { "Code", "Description" },
           new string[] { "Job_card_No", "Job_Description" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
    ...
    /// <summary>
    /// To get deffered job tooltip
    /// </summary>
    /// <param name="Vetting_ID">Id of vetting</param>
    /// <returns></returns>
    [WebMethod]
    public string VET_Get_DefferedJobsTooltip(int? Vetting_ID, int? Question_ID, int? Observation_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();
        ...
        return UDFLib.CreateHtmlTableFromDataTable(objBl.VET_Get_DefferedJobsTooltip(Vetting_ID, Question_ID, Observation_ID),
           new string[] { "Code", "Description" },
           new string[] { "Job_card_No", "Job_Description" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
    ...
    /// <summary>
    /// To get resonse tooltip
    /// </summary>
    /// <param name="Vetting_ID">Id of observation</param>
    /// <returns></returns>
    [WebMethod(EnableSession = true)]
    public string VET_Get_ObsResponseTooltip(int? Observation_ID)
    {
        SMS.Business.VET.BLL_VET_Index objBl = new SMS.Business.VET.BLL_VET_Index();
        ...
        DataTable dt = new DataTable();
        dt = objBl.VET_Get_ObsResponseTooltip(Observation_ID);
        if (dt.Rows.Count > 0)
        {
        ...
        return UDFLib.CreateHtmlTableFromDataTable(dt,
           new string[] { "Date", "Created By", "Responses" },
           new string[] { "Date_Of_Creation", "Created_By", "Response" },
           dicLink,
           new Dictionary<string, UDCToolTip>(),
           new string[] { "left", "left" },
          "CreateHtmlTableFromDataTable-table",

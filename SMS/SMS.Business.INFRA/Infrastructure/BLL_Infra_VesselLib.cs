...
/// <summary>
/// Summary description for BLL_Infra_Masters_Vessel
/// </summary>
/// 
namespace SMS.Business.Infrastructure
{
    ...
    public class BLL_Infra_VesselLib
    {
        DAL_Infra_VesselLib objDAL = new DAL_Infra_VesselLib();

        public BLL_Infra_VesselLib()
        {
            //
   ...
   /// 
        ...
        public int Upd_JiBeDeltaAutoSyncFlag(int Vessel_ID)
        {
            try
            {
                return objDAL.Upd_JiBeDeltaAutoSyncFlag_DL(Vessel_ID);
            }
            catch (Exception ex)
            {

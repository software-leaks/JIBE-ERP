...
namespace SMS.Data.Survey
{
    public class DAL_SURV_Survey
    {
        private string connection = "";
        public DAL_SURV_Survey(string ConnectionString)
        {
            connection = ConnectionString;
        }

        public DAL_SURV_Survey()
        {
        ...
        public DataTable Get_NASurvayList_DL(int FleetID, int VesselID, DataTable CatIDList, int CertificateID, int? Verified, int PageSize, int PageNumber, string SortBy, int SortDirection, ref int isfetchcount)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@FleetID", FleetID),
            ...
            DataTable ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "SURV_Sp_Get_NASurvayList_MultiCat", sqlprm).Tables[0];
        ...
        public DataTable INSERT_SurveyDetails_DL(int Vessel_ID, int Surv_Vessel_ID, DateTime DateOfIssue, DateTime DateOfExpiry, string Remarks, DateTime FollowupReminderDt, string FollowupReminder, int Created_By, int NoExpiry,
            int GraceRange, DateTime ExtensionDate, string CertificateNo, int IssuingAuthorityID)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@Vessel_ID", Vessel_ID),
            ...
            return SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "SURV_Sp_INSERT_SurveyDetails", sqlprm).Tables[0];
        }
        public int UPDATE_SurveyDetails_DL(int Vessel_ID, int Surv_Vessel_ID, int Surv_Details_ID, int Office_ID, DateTime DateOfIssue, DateTime DateOfExpiry, string Remarks, DateTime FollowupReminderDt, string FollowupReminder,
            int Modified_By, int NoExpiry, int GraceRange, DateTime ExtensionDate, string CertificateNo, int IssuingAuthorityID)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@Vessel_ID", Vessel_ID),
        ...
        public DataTable INSERT_SurveyDetails_DL(int Vessel_ID, int Surv_Vessel_ID, DateTime DateOfIssue, DateTime DateOfExpiry, string Remarks, DateTime FollowupReminderDt, string FollowupReminder, int Created_By, int NoExpiry,
            int GraceRange, DateTime ExtensionDate, string CertificateNo, int IssuingAuthorityID, int CertInspectionId, int RenewwalInspectionId)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@Vessel_ID", Vessel_ID),
                ...
                new SqlParameter("@Certificate_No", CertificateNo),
                new SqlParameter("@IssuingAuthority_ID", IssuingAuthorityID),
                new SqlParameter("@CertInspectionId", CertInspectionId),
                new SqlParameter("@RenewwalInspectionId", RenewwalInspectionId)
            };

            return SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "SURV_Sp_INSERT_SurveyDetails", sqlprm).Tables[0];
        }
        public DataTable UPDATE_SurveyDetails_DL(int Vessel_ID, int Surv_Vessel_ID, int Surv_Details_ID, int Office_ID, DateTime DateOfIssue, DateTime DateOfExpiry, string Remarks, DateTime FollowupReminderDt, string FollowupReminder,
            int Modified_By, int NoExpiry, int GraceRange, DateTime ExtensionDate, string CertificateNo, int IssuingAuthorityID, int CertInspectionId, int RenewwalInspectionId)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@Vessel_ID", Vessel_ID),
            ...
            return SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "SURV_Sp_UPDATE_SurveyDetails", sqlprm).Tables[0];
        }
        ...
        public int INSERT_Survey_Certificate_DL(string CertificateName, int CategoryID, int CreatedBy, int Term, string Survey_Cert_remarks, int? Alert_Insurance, int? GraceRange, bool InspectionRequired)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@CertificateName", CertificateName),
                ...
                new SqlParameter("@Alert_Insurance", Alert_Insurance),
                new SqlParameter("@GraceRange", GraceRange),
                new SqlParameter("@InspectionRequired", InspectionRequired),
                new SqlParameter("return",SqlDbType.Int)
            };
            sqlprm[sqlprm.Length - 1].Direction = ParameterDirection.ReturnValue;
            SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "SURV_Sp_INSERT_Survey_Certificate", sqlprm);
        ...
        public int UPDATE_Survey_Certificate_DL(int CertificateID, string CertificateName, int CategoryID, int ModifiedBy, int Term, string Survey_Cert_remarks, int? Alert_Insurance, int? GraceRange, bool InspectionRequired)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@CertificateID", CertificateID),
        ...
        public int DELETE_Survey_CertificateAttachment_DL(int Vessel_ID, int Surv_Details_ID, int SurvVessel_Att_ID, int DeletedBy)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@Vessel_ID", Vessel_ID ),
                new SqlParameter("@Surv_Details_ID", Surv_Details_ID ),
                new SqlParameter("@SurvVessel_Att_ID", SurvVessel_Att_ID ),
                new SqlParameter("@DeletedBy", DeletedBy),
                new SqlParameter("return",SqlDbType.Int)
            };
            sqlprm[sqlprm.Length - 1].Direction = ParameterDirection.ReturnValue;
            SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "SURV_DELETE_Survey_CertificateAttachment", sqlprm);
            return Convert.ToInt32(sqlprm[sqlprm.Length - 1].Value);
        }
        public int DELETE_Survey_Certificate_DL(int Surv_Details_ID, int Surv_Vessel_ID, int Vessel_ID, int OfficeID, int DeletedBy)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            {                 
                new SqlParameter("@Surv_Details_ID", Surv_Details_ID ),
            ...
            sqlprm[sqlprm.Length - 1].Direction = ParameterDirection.ReturnValue;
            SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "SURV_DEL_SurveyCertificate", sqlprm);
            return Convert.ToInt32(sqlprm[sqlprm.Length - 1].Value);
        }
        public int Chk_PreviousCertificate(int Vessel_ID, int Surv_Vessel_ID)
        {
            ...
            sqlprm[sqlprm.Length - 1].Direction = ParameterDirection.ReturnValue;
            SqlHelper.ExecuteNonQuery(connection, CommandType.StoredProcedure, "SURV_Chk_PreviousCertificate", sqlprm);
            return Convert.ToInt32(sqlprm[sqlprm.Length - 1].Value);
        }

        public DataTable Get_Survay_CertificateAuthorityList_DL(string searchtext, string sortby, int? sortdirection, int? pagenumber, int? pagesize, ref int isfetchcount)
        {
            ...
            obj[obj.Length - 1].Direction = ParameterDirection.InputOutput;
            System.Data.DataSet ds = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "SURV_Get_Certificate_AuthorityList", obj);
            isfetchcount = Convert.ToInt32(obj[obj.Length - 1].Value);
            return ds.Tables[0];
        }

        public DataTable Get_AssignedSurvayList_DL(int FleetID, int VesselID, int MainCatID, int CatID, string sortby, int? sortdirection, int? pagenumber, int? pagesize, ref int isfetchcount)
        {
            SqlParameter[] sqlprm = new SqlParameter[]
            { 
                new SqlParameter("@FleetID", FleetID),
            ...
            sqlprm[sqlprm.Length - 1].Direction = ParameterDirection.InputOutput;
            DataTable dt = SqlHelper.ExecuteDataset(connection, CommandType.StoredProcedure, "SURV_Sp_Get_AssignedSurvayList", sqlprm).Tables[0];
            isfetchcount = Convert.ToInt32(sqlprm[sqlprm.Length - 1].Value);
            return dt;
        }
    }

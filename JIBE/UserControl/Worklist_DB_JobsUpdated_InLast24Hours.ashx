<%@ WebHandler Language="C#" Class="Worklist_DB_JobsUpdated_InLast24Hours" %>
...
public class Worklist_DB_JobsUpdated_InLast24Hours : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            DataTable dt = objBllWL.Get_WL_JobsUpdated_InLast24Hours();

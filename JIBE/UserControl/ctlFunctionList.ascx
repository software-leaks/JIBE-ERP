<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ctlFunctionList.ascx.cs" Inherits="UserControl_ctlFunctionList" %>
<style type="text/css">
    .portList-Popup
    {
        position: absolute;
            ...
            <table cellpadding="0" cellspacing="0">
                <tr>
                    <td style="border: 0px; padding: 0">
                        <asp:TextBox ID="txtSelectedFunction" Font-Size="11px" runat="server" Width="240px" Enabled="false"></asp:TextBox>
                    </td>
                    <td style="border: 0px; padding: 0">
            ...
            <table cellpadding="2" cellspacing="2" style="width: 100%">
                <tr>
                    ...
                    <td style="text-align: left;">
                        <asp:TextBox ID="txtSearchFunction" runat="server" AutoPostBack="true" OnTextChanged="txtSearchFunction_TextChanged"
                ...
                <tr>
                    <td colspan="3">
                        <asp:ListBox ID="lstFunctionList" runat="server" Width="250px" Height="250px" OnSelectedIndexChanged="lstFunctionList_SelectedIndexChanged"

<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Company.aspx.cs"
    Inherits="Company" Title="Company" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CompanyTypeChanged(val) {
            if (val == 9) {

                document.getElementById("<%=ddlParentCompany.ClientID%>").value = "1";
                document.getElementById("<%=ddlParentCompany.ClientID%>").disabled = true;

                document.getElementById("<%=ddlRelation.ClientID%>").value = "5";
                document.getElementById("<%=ddlRelation.ClientID%>").disabled = true;
            }
            else {
                document.getElementById("<%=ddlParentCompany.ClientID%>").value = "0";
                document.getElementById("<%=ddlParentCompany.ClientID%>").disabled = false;

                document.getElementById("<%=ddlRelation.ClientID%>").value = "0";
                document.getElementById("<%=ddlRelation.ClientID%>").disabled = false;
          ...
          <div style="border: 1px solid #cccccc; font-family: Tahoma; font-size: 12px; width: 95%;">
            ...
            <div style="width: 100%; height: 650px; color: Black;">
                <asp:UpdatePanel ID="UpdatePaneCompany" runat="server">
                  ...
                  <%--    
                      <table >
                      <tr><td>Register your company in Jibe:</td>
                      <td>
                       <asp:ImageButton ID="ImgAdd" runat="server" ImageUrl="~/Images/Add-icon.png" OnClick="ImgAdd_Click"
                                            ToolTip="Add New Company" />
                      </td></tr>
                       ...
                       <br />
                       <br />
                       <%-- <div id="divadd" title="<%= OperationMode %>" style="display: block; border: 1px solid Gray;
                            ...
                            font-family: Tahoma; text-align: left; font-size: 12px; color: Black; width: 68%;">
                            <center>
                                <table width="98%" cellpadding="2" cellspacing="2">
                                    <tr>
                                        ...
                                        <td align="right" style="width: 25%">
                                            <asp:DropDownList ID="ddlCompanyType" runat="server" Width="102%" 
                                                CssClass="txtInput" onchange="CompanyTypeChanged(this.options[this.selectedIndex].value)"
                                    ...
                                    <tr>
                                        ...
                                        <td align="right">
                                            <asp:TextBox ID="txtCompCode" runat="server" CssClass="txtInput" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtCompName" runat="server" MaxLength="50" CssClass="txtInput" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right">
                                            Company Short Name : &nbsp;
                                        </td>
                                        ...
                                        *
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtShortName" runat="server" MaxLength="10" CssClass="txtInput" Width="100%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtDtIncorp" runat="server" CssClass="txtInput" Width="100%"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtAddrerss" TextMode="MultiLine" MaxLength="250" Rows="3" Width="100%" CssClass="txtInput"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtEmail" runat="server" MaxLength="250" CssClass="txtInput" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right">
                                            Email 2 : &nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtPhone" runat="server" MaxLength="50" CssClass="txtInput" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right">
                                            Phone 2 : &nbsp;
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtFax1" runat="server" MaxLength="50" CssClass="txtInput" Width="100%"></asp:TextBox>
                                        </td>
                                        <td align="right">
                                            Fax 2 : &nbsp;
                                        </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QueryBuilder.aspx.cs" Inherits="Infrastructure_DaemonSettings_QueryBuilder" %>
    ...
    <div class="ui-layout-west">
        <asp:UpdatePanel ID="UpdatePanel_west" runat="server">
            <ContentTemplate>
                ...
                <div class="toolbox">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCatalog" runat="server" Width="80px">
                                </asp:DropDownList>
                                <asp:Button ID="btnLogin" runat="server" Width="80px" Text="LogIn" OnClick="btnLogin_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: center">
                ...
                <div class="toolbox">
                    <asp:Panel ID="pnlDBProcedures" runat="server" Visible="false">
                        <div>
                            <asp:ImageButton ID="btnReloadDBProcedures" runat="server" OnClick="btnReloadDBProcedures_Click"
                                ImageUrl="~/Images/reload.png" ImageAlign="AbsBottom" />
                        </div>
                        <asp:ListBox ID="lstDBProcedures" runat="server" Width="250px" Height="400px" OnSelectedIndexChanged="lstDBProcedures_SelectedIndexChanged"
            ...
            <ContentTemplate>
                ...
                <div id="dvToolBar" class="toolbar">
                    ...
                    <asp:Panel ID="pnlCtl" runat="server" Visible="false">
                        <asp:Button ID="btnSaveQueryAs" runat="server" Text="Save Query As" BorderStyle="Solid"
                            OnClick="btnSaveQueryAs_Click" BorderColor="#0489B1" BorderWidth="1px" Font-Names="Tahoma"
                            Height="24px" BackColor="#81DAF5" />
                        <asp:Button ID="btnSaveQuery" runat="server" Text="Save Query" BorderStyle="Solid"
                ...
                <asp:TextBox ID="txtQuery" runat="server" TextMode="MultiLine" CssClass="text-editor"
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCommandType" runat="server" Width="260px">
                                <asp:ListItem Text="SQL Statement" Value="SQLQuery"></asp:ListItem>
                                <asp:ListItem Text="SQL Stored Procedure" Value="Procedure"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>

...
public partial class ApprovalGroup : System.Web.UI.Page
{
    ...
    BLL_Infra_Approval_Group objBLLAppGroup = new BLL_Infra_Approval_Group();
    ...
    public void BindApprovalGroup()
    {
        ...
        DataTable dt = objBLLAppGroup.Get_Approval_Group_Search(txtfilter.Text != "" ? txtfilter.Text : null, sortbycoloumn, sortdirection
    ...
    protected void onDelete(object source, CommandEventArgs e)
    {
        ...
        int retval = objBLLAppGroup.Del_Approval_Group(Convert.ToInt32(e.CommandArgument.ToString()), Convert.ToInt32(Session["USERID"]));
        BindApprovalGroup();
    ...
    protected void ImgExpExcel_Click(object sender, EventArgs e)
    {
        ...
        string[] HeaderCaptions = { "Group Name"};

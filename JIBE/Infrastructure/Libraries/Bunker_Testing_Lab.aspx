<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bunker_Testing_Lab.aspx.cs"  MasterPageFile="~/Site.master" Inherits="Infrastructure_Libraries_Bunker_Testing_Lab" Title="Bunker Testing Lab" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ctl00_MainContent_txtLabName").value == "") {
                alert("Please Enter Bunker Testing Lab Name.");
            ...
            var txtMobile = document.getElementById("ctl00_MainContent_txtPhone");
            if (txtMobile.value != "") {
                if (!mob.test(txtMobile.value)) {
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="GridView_Labs" runat="server" EmptyDataText="NO RECORDS FOUND"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Lab Name" SortExpression="Company_Name">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lnkLabNameH" runat="server" CommandName="Sort" CommandArgument="Company_Name"
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lnkLabName" runat="server" CommandArgument='<%#Eval("ID")%>'
                                                    Text='<%# Eval("Company_Name") %>' Style="color: Black" OnCommand="onUpdate"></asp:LinkButton>
                                            </ItemTemplate>
                                            ...
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lnkCountryH" runat="server" CommandName="Sort" CommandArgument="Country"
                                                    ForeColor="Black">Country&nbsp;</asp:LinkButton>
                                                <asp:Image ID="imgCountry_Name" runat="server" Visible="false" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblCountry_Name" runat="server" Text='<%#Eval("Country")%>'></asp:Label>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Phone" SortExpression="Phone1">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lnkPhoreH" runat="server" CommandName="Sort" CommandArgument="Phone1"
                                        ...
                                        <asp:TemplateField HeaderText="EMail" SortExpression="EMail1">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lnkEMailH" runat="server" CommandName="Sort" CommandArgument="EMail1"

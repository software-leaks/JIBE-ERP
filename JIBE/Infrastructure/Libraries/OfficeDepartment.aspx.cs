...
public partial class OfficeDepartment : System.Web.UI.Page
{

    BLL_Infra_OfficeDepartment objBLL = new BLL_Infra_OfficeDepartment();
    ...
    public void BindOfficeDepartment()
    {
        ...
        DataTable dt = objBLL.SearchOfficeDepartment(txtfilter.Text != "" ? txtfilter.Text : null, UDFLib.ConvertIntegerToNull(ddl_Vessel_Manager_Filter.SelectedValue), sortbycoloumn, sortdirection
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        ...
        {
            int retval = objBLL.InsertOfficeDepartment(txtDepartment.Text, UDFLib.ConvertIntegerToNull(ddl_Vessel_Manager_Add.SelectedValue), Convert.ToInt32(Session["USERID"]));
        }
        else
        {
            int retval = objBLL.EditOfficeDepartment(Convert.ToInt32(txtDeptID.Text.Trim()), txtDepartment.Text, UDFLib.ConvertIntegerToNull(ddl_Vessel_Manager_Add.SelectedValue), Convert.ToInt32(Session["USERID"]));
        }
    ...
    protected void onUpdate(object source, CommandEventArgs e)
    {
        ...
        dt = objBLL.Get_OfficeDepartment_List(Convert.ToInt32(e.CommandArgument.ToString()));
        ...
        string InfoDiv = "Get_Record_Information_Details('INF_LIB_INOFFICE_DEPT','ID=" + txtDeptID.Text + "')";
    ...
    protected void onDelete(object source, CommandEventArgs e)
    {
        ...
        int retval = objBLL.DeleteOfficeDepartment_DL(Convert.ToInt32(e.CommandArgument.ToString()), Convert.ToInt32(Session["USERID"]));
    ...
    protected void ImgExpExcel_Click(object sender, EventArgs e)
    {
        ...
        DataTable dt = objBLL.SearchOfficeDepartment(txtfilter.Text != "" ? txtfilter.Text : null, UDFLib.ConvertIntegerToNull(ddl_Vessel_Manager_Filter.SelectedValue)
        ...
        GridViewExportUtil.ShowExcel(dt, HeaderCaptions, DataColumnsName, "OfficeDepartment", "Office Department", "");

...
public partial class SearchVessel : System.Web.UI.Page
{
    ...
    DropDownList ddlFleet_AddVessel = new DropDownList();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            try
            {
                ...
                ddlFilterVesselManager.SelectedIndex = 0;
                BindVesselFlagDDL();
    ...
    public void BindVesselFlagDDL()
    {
        ...
        DataTable dt = objBLL.Get_Survey_VesselFlagList();
    ...
    public void Load_FleetList()
    {
        ...
        //DataTable dtfleet = objBLL.GetFleetList_ByID(null, UDFLib.ConvertIntegerToNull(Session["USERCOMPANYID"].ToString()));
    ...
    public void Load_VesselList(int VMID)
    {
        //int Fleet_ID = int.Parse(DDLFleet.SelectedValue);
        int Fleet_ID = 0;
        int UserCompanyID = VMID;
        ...
        DDLVessel.DataSource = objBLL.Get_SURVEY_VesselList(0, 0, UserCompanyID, "", Vessel_Manager);

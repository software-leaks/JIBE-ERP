<%@ Page Title="User Type" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="UserType.aspx.cs" Inherits="UserType" %>
                        ...
                        <div style="padding-top: 5px; padding-bottom: 5px; height: 40px; width: 100%">
                            <table width="100%" cellpadding="4" cellspacing="4">
                                <tr>
                                    ...
                                    <td align="center" style="width: 5%">
                                        <asp:ImageButton ID="ImgAdd" runat="server" ToolTip="Add New UserType" OnClick="ImgAdd_Click"
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="gvUserType" runat="server" EmptyDataText="NO RECORDS FOUND" AutoGenerateColumns="False"
                                    OnRowDataBound="gvUserType_RowDataBound" DataKeyNames="ID" CellPadding="1" CellSpacing="0"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="UserType">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lblUserTypeHeader" runat="server" CommandName="Sort" CommandArgument="User_Type"
                                                    ForeColor="Black">User Type&nbsp;</asp:LinkButton>
                                                <img id="User_Type" runat="server" visible="false" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lblUserType" runat="server" Text='<%#Eval("User_Type")%>' Style="color: Black"
                                ...
                                <uc1:ucCustomPager ID="ucCustomPagerItems" runat="server" PageSize="30" OnBindDataItem="BindUserType" />
                        ...
                        <div id="divadd" title="<%= OperationMode %>" style="display: none; font-family: Tahoma;
                            ...
                            <table width="100%" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtUserType" CssClass="txtInput" Width="90%" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>

<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Country.aspx.cs"
    Inherits="Country" Title="Country" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ctl00_MainContent_txtCountry").value.trim() == "") {
                alert("Please enter country name.");
                document.getElementById("ctl00_MainContent_txtCountry").focus();
                return false;
            }

            if (document.getElementById("ctl00_MainContent_txtISOCode").value.trim() == "") {
                alert("Please enter ISO code.");
                document.getElementById("ctl00_MainContent_txtISOCode").focus();
                return false;
            }
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div style="padding-top: 5px; padding-bottom: 5px; height: 40px; width: 100%">
                            <table width="100%" cellpadding="4" cellspacing="4">
                                <tr>
                                    ...
                                    <td align="center" style="width: 5%">
                                        <asp:ImageButton ID="ImgAdd" runat="server" ToolTip="Add New Country" OnClick="ImgAdd_Click"
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="GridViewCountry" runat="server" EmptyDataText="NO RECORDS FOUND"
                                    AutoGenerateColumns="False" OnRowDataBound="GridViewCountry_RowDataBound" DataKeyNames="ID"
                                    CellPadding="1" CellSpacing="0" Width="100%" GridLines="both" OnSorting="GridViewCountry_Sorting"
                                    AllowSorting="true">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Country">
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lblName" Style="color: Black" runat="server" Text='<%#Eval("Country_Name")%>'
                                        ...
                                        <asp:TemplateField HeaderText="ISO Code">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lblISOHeader" runat="server" CommandName="Sort" CommandArgument="ISO_Code"
                                                    ForeColor="Black">ISO Code&nbsp;</asp:LinkButton>
                                                <img id="ISO_Code" runat="server" visible="false" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblISO" runat="server" Text='<%#Eval("ISO_Code")%>'></asp:Label>
                                            </ItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Image ID="imgRecordInfo" ImageAlign="AbsMiddle" ImageUrl="~/Images/RecordInformation.png"
                                                                Height="16px" Width="16px" runat="server" onclick='<%# "Get_Record_Information(&#39;LIB_Country&#39;,&#39;ID="+Eval("ID").ToString()+"&#39;,event,this)" %>' />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                ...
                                <uc1:ucCustomPager ID="ucCustomPagerItems" runat="server" PageSize="30" OnBindDataItem="BindCountry" />
                        ...
                        <div id="divadd" title="<%= OperationMode %>" style="display: none; border: 1px solid Gray;
                            ...
                            <table cellpadding="2" cellspacing="2" width="100%" style="padding-top: 10px;">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtCountry" Width="99%" MaxLength="250" CssClass="txtInput" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtISOCode" Width="40%" MaxLength="5" CssClass="txtInput" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" style="font-size: 11px; text-align: center; border-style: solid;
                                        ...
                                        <asp:TextBox ID="txtCountryID" runat="server" Visible="false" Width="1px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">

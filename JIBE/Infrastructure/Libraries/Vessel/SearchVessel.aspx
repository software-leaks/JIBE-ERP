<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" EnableEventValidation="false"
    CodeFile="SearchVessel.aspx.cs" Inherits="SearchVessel" Title="Search Vessel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validationOnVesselSave() {
            ...
            if (document.getElementById("ctl00_MainContent_dtTakeoverDate").value.trim() == "") {
                alert("Please enter take over date.");
                document.getElementById("ctl00_MainContent_dtTakeoverDate").focus();
                return false;
            }
            var takeoverdate = document.getElementById("ctl00_MainContent_dtTakeoverDate").value;

            var parsedDate = Date.parse(takeoverdate);
            if (!isValidDate(takeoverdate)) {
                alert("Take over date is not valid.");
                document.getElementById("ctl00_MainContent_dtTakeoverDate").focus();
                return false;
            }

            var takeoverdate = document.getElementById("ctl00_MainContent_dtHandoverDate").value;

            if (document.getElementById("ctl00_MainContent_dtHandoverDate").value.trim() != "") {
                var handoverdate = document.getElementById("ctl00_MainContent_dtHandoverDate").value;
                if (!isValidDate(handoverdate)) {
                    alert("Hand over date is not valid.");
                    document.getElementById("ctl00_MainContent_dtHandoverDate").focus();
                    return false;
                }
            }


            if (document.getElementById("ctl00_MainContent_txtMinimumCTM").value.trim() != "") {
                var MinimumCTM = document.getElementById("ctl00_MainContent_txtMinimumCTM").value;
                if (isNaN(MinimumCTM)) {
                    alert("Minimum CTM is not valid.");
                    document.getElementById("ctl00_MainContent_txtMinimumCTM").focus();
                    return false;
                }
            }


            var emailval = document.getElementById("ctl00_MainContent_txtEmailID").value.trim();
            if (emailval != "") {
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Min CTM">
                                         ...
                                         <asp:TemplateField HeaderText="Call Sign">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCallSign" runat="server" Text='<%# Eval("VESSEL_CALL_SIGN")%>'></asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="70px" CssClass="PMSGridItemStyle-css">
                                            </ItemStyle>
                                            <HeaderStyle Wrap="true" HorizontalAlign="Left" />
                                        ...
                                        <asp:TemplateField HeaderText="Is Vessel">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkIsVessel" runat="server" Checked='<%#((int)Eval("ISVESSEL"))==1?true:false%>'  Enabled="false" />
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" HorizontalAlign="Center" Width="60px" CssClass="PMSGridItemStyle-css">
                                            </ItemStyle>
                                            <HeaderStyle Wrap="true" HorizontalAlign="Center" />
                    ...
                    <table width="98%" cellpadding="2" cellspacing="2">
                        ...
                        <tr>
                         <td align="right">
                            ...
                            <td align="left">
                                <asp:CheckBox ID="chkIsVessel" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtImoNo" runat="server" Width="80%" MaxLength="50" CssClass="txtInput"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                        ...
                        <tr>
                            <td align="left" colspan="3" style="border-bottom: 1px solid gray; padding-bottom: 15px">
                                <asp:FileUpload ID="FileUploader" ToolTip="Attach File" Style="width: 90%; height: 18px; background-color: #F2F2F2;
                        ...
                        <tr>
                         ...
                         <tr>
                            <td colspan="3" align="left">
                                <asp:HyperLink ID="lnkVslImage" runat="server" Target="_blank"> </asp:HyperLink>
                                <asp:ImageButton ID="ImgVslImgDelete" runat="server" Height="14px" ForeColor="Black" 
                                    ToolTip="Delete attached Image" ImageUrl="~/Images/Delete.png" OnClick="ImgVslImgDelete_click" />
                            </td>
                        </tr>
                        <tr>
                            <td align="left" colspan="3" style="border-bottom: 1px solid gray; padding-bottom: 15px">
                                <asp:FileUpload ID="VesselImageUploader"  ToolTip="Attach Vessel Image" Style="width: 90%; height: 18px;  background-color: #F2F2F2;
                                    border: 1px solid #cccccc; font-size: 12px; cursor: pointer" runat="server" />
                            </td>
                        </tr>
                        <tr>

<%@ Page Title="VesselType" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="VesselType.aspx.cs" Inherits="Infrastructure_Libraries_Vessel_VesselType" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ctl00_MainContent_txtUserType").value.trim() == "") {
                    ...
                    <ContentTemplate>
                        <div style="padding-top: 5px; padding-bottom: 5px; height: 40px; width: 100%">
                            <table width="100%" cellpadding="4" cellspacing="4">
                                ...
                                <%--    </td>
                                    ...
                                    <td align="center" style="width: 5%">
                                        <asp:ImageButton ID="ImgAdd" runat="server" ToolTip="Add New VesselType" OnClick="ImgAdd_Click"
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="gvVesselType" runat="server" EmptyDataText="NO RECORDS FOUND" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="UserType">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lblUserTypeHeader" runat="server" CommandName="Sort" CommandArgument="VesselTypes"
                                                    ForeColor="Black">Vessel Type&nbsp;</asp:LinkButton>
                                                <img id="VesselTypes" runat="server" visible="false" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lblUserType" runat="server" Text='<%#Eval("VesselTypes")%>' Style="color: Black"
                                         ...
                                         <asp:TemplateField HeaderText="TankerType">
                                          
                                            <ItemTemplate>
                                                  <asp:Label ID="lblTankerType" runat="server"  CommandArgument="TankerType" Text='<%#Eval("TankerType")%>'
                                                    ForeColor="Black">Tanker Type&nbsp;</asp:Label>
                                            </ItemTemplate>
                                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="150px" CssClass="PMSGridItemStyle-css">
                                            </ItemStyle>
                                            <HeaderStyle Wrap="true" HorizontalAlign="Left" />
                                ...
                                <uc1:ucCustomPager ID="ucCustomPagerItems" runat="server" PageSize="30" OnBindDataItem="BindVesselType" />
                        ...
                        <div id="divadd" title="<%= OperationMode %>" style="display: none; font-family: Tahoma;
                            ...
                            <table width="100%" cellpadding="2" cellspacing="2">
                                ...
                                <td align="right" style="width: 20%">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddlTanker" MaxLength="50" CssClass="txtInput" Width="90%" runat="server">

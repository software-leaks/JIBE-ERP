                                ...
                                <table width="98%" cellpadding="2" cellspacing="2">
                                    <tr>
                                        ...
                                        <td align="right" style="width: 25%">
                                            <asp:DropDownList ID="ddlCompanyType" runat="server" Width="102%" CssClass="txtInput">
                                            </asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtAddrerss" TextMode="MultiLine" MaxLength="250" Rows="3" Width="100%"
                                    ...
                                    <tr id="trDateFormat" runat="server">
                                        ...
                                        <td align="left">
                                            <asp:DropDownList ID="ddlDateFormat" runat="server" CssClass="txtDateFormat" Width="102%">

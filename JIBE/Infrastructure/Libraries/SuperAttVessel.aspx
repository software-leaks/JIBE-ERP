<%@ Page Title="Superintendents Attending Vessel" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="SuperAttVessel.aspx.cs" Inherits="SuperAttVessel" %>
    ...
    <center>
       ...
       <asp:UpdateProgress ID="upUpdateProgress"  runat="server">
        ...
        <div style="border: 1px solid #cccccc; font-family: Tahoma; font-size: 12px; width: 100%;
            ...
            Superintendents Attending Vessel
          </div>
                    ...
                    <ContentTemplate>
                        <table cellpadding="0" cellspacing="0" width="100%" style="padding-top: 30px">
                            <tr style="background-color: #E6EFFA;">
                                ...
                                <td style="width: 17%; background-color: #E6EFFA; font-weight: 700;">
                                    Selected User List :&nbsp;&nbsp;
                                </td>
                                <td align="left" style="width: 30%">

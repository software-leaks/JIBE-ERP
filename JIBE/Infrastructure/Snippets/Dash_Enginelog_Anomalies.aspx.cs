...
using System.Data;
public partial class Infrastructure_Snippets_Dash_Enginelog_Anomalies : System.Web.UI.Page
{

    protected void Page_Load(object sender, EventArgs e)
    {
        DataSet ds = BLL_Infra_DashBoard.Get_Enginelog_Anomalies(Convert.ToInt32(Session["USERID"]));
        gvEnginelogAnomalies.DataSource = ds;
        ViewState["rowcnt"] = ds.Tables[0].Rows.Count - 1;
        gvEnginelogAnomalies.DataBind();
    ...
    protected void gvEnginelogAnomalies_RowDataBound(object sender, GridViewRowEventArgs e)
    {

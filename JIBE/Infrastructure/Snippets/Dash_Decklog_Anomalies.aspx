<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Dash_Decklog_Anomalies.aspx.cs" Inherits="Infrastructure_Snippets_Dash_Decklog_Anomalies" %>
...
<body>
    ...
    <div id="dvDeckLog"> 
     <asp:GridView ID="gvDecklogAnomalies" GridLines="None" runat="server" 
            EmptyDataText="No record found !" CellPadding="3"
            AutoGenerateColumns="false" Width="100%" 
            onrowdatabound="gvDecklogAnomalies_RowDataBound">

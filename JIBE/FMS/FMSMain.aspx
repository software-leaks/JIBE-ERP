<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FMSMain.aspx.cs"
    Inherits="Main" Title="File Management System" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            document.getElementById('docPreview').src = 'FMSFileLoader.aspx';


            $('.fileTreeDemo').fileTree({
                root: 'DOCUMENTS',
                script: 'FMSLoadTree.aspx',
                multiFolder: true
            },
                function (id, path, type) {
                    if (type == 1) {
                        //Folder node click
                        document.getElementById('docPreview').src = 'FMSAddNewFile.aspx?Path=' + path + '&id=' + id;
                    }
                    else {
                        //File node click                        
                        document.getElementById('docPreview').src = 'FMSFileLoader.aspx?DocID=' + id;
                    }
                }
            );
        });
        ...
        <table width="100%" cellspacing="5">
            <tr>
                <td style="vertical-align: top; background-color: #f8f8f8; width: 250px; padding: 5;
                    ...
                    <div style="background-color: #f8f8f8; text-align: left; height: 800px; width: 250px;
                        ...
                        <table>
                            <tr>
                                <td colspan="2">
                                    <asp:CheckBox ID="chkShowArchivedForms" runat="server" AutoPostBack="true" Text="Show archived forms"
                                        TextAlign="Left" OnCheckedChanged="chkShowArchivedForms_CheckedChanged" />
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align: middle;">
                                    <div onclick="DocOpenOnIFrame('FMSAddNewFile.aspx?Path=FMSL/&id=0');$('.fileTreeDemo').find('.selected').removeClass('selected');"
                ...
                <td style="vertical-align: top; border: 1px solid #c3c3c3">
                    <iframe id="docPreview" name="docPreview" style="height: 800px; width: 100%; border: 0px;

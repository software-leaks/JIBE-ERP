...
public partial class CheckOutForm : System.Web.UI.Page
{
    ...
    public void showSaveDialog()
    {
        ...
        if (dsLastestFileAccessType.Tables[0].Rows.Count > 0)
        {
            ...
            {
                String msg = String.Format("myMessage('You have already Checked Out the file.');window.location.href='FMSFileLoader.aspx?docid=" + fileID + "';");
                ScriptManager.RegisterStartupScript(Page, Page.GetType(), "msg", msg, true);
    ...
    public void browseFileDialog()
    {
        ...
        objFMS.insertRecordAtCheckout(Convert.ToInt32(Session["USERID"]), fileID);
    ...
    public void OpenFileExternal(string url,string filename)
    {
        ...
        {
            String FlErr = String.Format("myMessage('File Not Found'); window.location.href='FMSFileLoader.aspx?docid=" + fileID + "';");
            ScriptManager.RegisterStartupScript(Page, Page.GetType(), "FlErr", FlErr, true);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FMSCheckInForm.aspx.cs" Inherits="CheckInForm" %>
                        ...
                        <tr>
                         ...
                         <tr>
                                ...
                                <td>
                                   ...
                                   <asp:TextBox ID="txtFormType" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                        <tr>
                            <td style="vertical-align: top;">
                            ...
                            <td>
                                <asp:TextBox ID="txtDepartment" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                                <td style="vertical-align: top;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtFormat" runat="server" Width="200px" Enabled="false"></asp:TextBox>
                                </td>
                            </tr>
                        <tr>
                            <td>

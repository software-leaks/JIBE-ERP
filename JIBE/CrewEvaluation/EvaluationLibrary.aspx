<%@ Page Title="Crew Evaluation Library" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="EvaluationLibrary.aspx.cs" Inherits="CrewEvaluation_EvaluationLibrary" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function showDiv(dv) {
            ...
            document.getElementById('dvAddNewType').title = "Add New Evaluation Type"
            showModal(dv);
        }
        function closeDiv(dv) {
            hideModal(dv);
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
                                        ...
                                        <tr>
                                            <td style="text-align: right">
                                                <asp:LinkButton ID="lnkAddNewType" OnClientClick="javascript:showDiv('dvAddNewType');return false;"
                                                    runat="server" CssClass="linkbtn">Add New Evaluation Type</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                      ...
                                      <HeaderStyle CssClass="HeaderStyle-css" Height="25px" />
                                        <Columns>
                                            <asp:TemplateField HeaderText="Evaluation Type">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEvaluation_Type" runat="server" Text='<%#Eval("Evaluation_Type")%>'></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtEvaluation_Type" Font-Size="11px" MaxLength="50" runat="server"
                                                        Text='<%#Bind("Evaluation_Type")%>'></asp:TextBox>
                                                </EditItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Edit" ShowHeader="False" HeaderStyle-Width="50px">
  ...
  <div id="dvAddNewType" title="Add New Evaluation Type" class="modal-popup-container"
               style="width: 550px; left: 40%; top: 30%;">

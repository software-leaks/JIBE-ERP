    ...
    var password_Strength = new function () {
        ...
        this.getStrengthInfo = function (passwordVal) {
            ...
            if (nums >= password_settings.numberLength) {
                ...
                msg += "At least " + (password_settings.numberLength - nums) + " more numbers, ";
            }
            ...
            if (specials >= password_settings.specialLength) {
                ...
                msg += "At least " + (password_settings.specialLength - specials) + " more symbol, ";
            }
            ...
            if (uppers >= password_settings.upperLength) {
                ...
                msg += "At least " + (password_settings.upperLength - uppers) + " Upper case characters, ";
            }
            ...
            if (lowers === 0) {
                ...
                msg += "At least 1 lower case character, ";
            }
            ...
            $(this).keyup(function () {
                ...
                if (passwordVal.length > 0) {
                    ...
                    if (password_settings.useMultipleColors === "1") {
                        ...
                        //33% to 66% is blue
                        //33% to 99% is blue
                        else if (parseInt(strengthPercent) >= (barWidth * .33) && parseInt(strengthPercent) <= (barWidth * .99)) {
                            backColor = "red";
                        }
                        else {
                            backColor = password_settings.barColor;

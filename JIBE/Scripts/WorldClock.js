function worldClock(zone, region, city) {
    var dst = 0
    var time = new Date()
    ...
    if (dst == 1) {
        ...
        return "<div class='digiClock'>" + city + "<div>" + monthArray[month] + " " + day + ", " + year + "<div>" + hr + ":" + min + ":" + sec + " DST" + '</div></div></div>'
    }
    else {
        return "<div class='digiClock'>" + city + "<div>" + monthArray[month] + " " + day + ", " + year + "<div>" + hr + ":" + min + ":" + sec + '</div></div></div>'
    }
}

...
(function ($) {
    $.fn.Thesaurus = function (options) {

        var defaults = {
            title: 'Share',
            lists: 'Search,http://www.google.com/search?q=%s',
            truncateChars: 115,
            extraClass: '',
            borderColor: '#444',
            background: '#fff',
        ...
        function createListBox(ele, e) {
            ...
            stsBox = '<div class="stsBox ' + options.extraClass + '">';
            //stsBox += '<div class="title">' + options.title + '<a href="http://www.aakashweb.com" title="What is this ?" target="_blank" rel="follow">?</a></div>';
            stsBox += '<div class="list"><ul></ul></div><span class="arrow"></span></div>';
        ...
        function addToList(ele) {
            ...
            ele.css({ "color": "blue", "text-decoration": "underline" });

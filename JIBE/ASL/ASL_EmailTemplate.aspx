<%@ Page Title="Email Template" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ASL_EmailTemplate.aspx.cs"
 validateRequest="false" Inherits="ASL_ASL_EmailTemplate" EnableEventValidation="false" %>
   ...
   <link href="../Styles/jquery-ui.css" rel="stylesheet" type="text/css" />
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ctl00_MainContent_ddlEmailStatus").value == "0") {
                alert("Email Status is mandatory field.");
                document.getElementById("ctl00_MainContent_ddlEmailStatus").focus();
                return false;
            }

            if (document.getElementById("ctl00_MainContent_txtemailbody").value == "") {
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="gvVesselType" runat="server" EmptyDataText="NO RECORDS FOUND" AutoGenerateColumns="False"
                                    OnRowDataBound="gvVesselType_RowDataBound" DataKeyNames="ID" CellPadding="1" CellSpacing="0"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="EmailStatus">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lblUserTypeHeader" runat="server" CommandName="Sort" CommandArgument="Email_Status"
                                                    ForeColor="Black">Email Status&nbsp;</asp:LinkButton>
                                                <img id="UserType" runat="server" visible="false" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                            <asp:Label ID="lblEmail_Status" runat="server" Text='<%#Eval("Email_Status")%>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="Email Body">
                                            ...
                                            <ItemStyle Wrap="true" HorizontalAlign="Left" Width="260px" CssClass="PMSGridItemStyle-css">
                                            </ItemStyle>
                                            <HeaderStyle Wrap="true" HorizontalAlign="Center" />
                                        </asp:TemplateField>
                        ...
                        <div id="divadd" title="<%= OperationMode %>" style="display: none; font-family: Tahoma;
                            ...
                            <table width="100%" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddlEmailStatus" runat="server" CssClass="txtInput" Width="400px">
                                                </asp:DropDownList>
                                                 <asp:RequiredFieldValidator ID="rfvPhoneNumber" runat="server" Display="None" ErrorMessage="Email Status is mandatory field."
                                                            ControlToValidate="ddlEmailStatus" InitialValue="0" ValidationGroup="vgSubmit" ForeColor="Red"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" style="width: 20%">
                                ...
                                <tr>
                                    ...
                                    <CKEditor:CKEditorControl ID="txtemailbody"  Height="100px" Width="90%" CssClass="cke_show_borders" runat="server"></CKEditor:CKEditorControl>
                                           <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="None" ErrorMessage="Email Body is mandatory field."
                                                            ControlToValidate="txtemailbody"  ValidationGroup="vgSubmit" ForeColor="Red"></asp:RequiredFieldValidator>   
                                    </td>
                                </tr>

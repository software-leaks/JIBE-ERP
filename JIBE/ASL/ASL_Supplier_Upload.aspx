<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="ASL_Supplier_Upload.aspx.cs"
    Inherits="ASL_ASL_Supplier_Upload" %>
        ...
        <center>
            <div style="border: 1px solid #cccccc; font-family: Tahoma; font-size: 12px; width: 100%;
                        ...
                        <td>
                                ...
                                <table id="Divstep1" visible="false" runat="server" width="100%">
                                    <tr>
                                        <td align="left" colspan="4" style="width: 10%">
                                            Step 1 : Confirm the Purchase order which the invoice is to be matched.
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div style="border: 1px solid #cccccc; font-family: Tahoma; font-size: 12px; width: 100%;">
                                <table id="Divstep2" runat="server" visible="false">
                                    <tr>
                                        <td align="left" colspan="4" style="width: 15%">
                                            Step 2 : Upload scanned invoice attachment. Please read following instructions.<br />
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div style="border: 1px solid #cccccc; font-family: Tahoma; font-size: 12px; width: 100%;">
                                <table id="DivStep3" runat="server" visible="false">
                                    <tr>
                                        <td align="left" colspan="4" style="width: 15%">
                                            Step 3 : Update invoice details and remarks.<br />
                                            <br />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <asp:Label ID="lblReject" runat="server" Visible="false" Text="Your uploaded invoice IS REJECTED. Please see below for further information."></asp:Label>
                                            <asp:Label ID="lblNotReject" runat="server" Visible="true" Text="You are required to enter data into all the fields provided, Only remarks is optional.
                                            Once done, click on the [Update Invoice Data] to save the data. The [Submit for
                                            Payment] button will only be enabled after the required fields are complete. Invoice
                                            Currency must be the same as Purchase Order Currency. If there are additional invoices
                                            relating to the Purchase Order, please email them to the respective buyers for processing.
                                            Once you have uploaded the electronic invoice, you are no longer required to send
                                            us the Original Invoice."></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td align="left" width="40%">
                                            <asp:TextBox ID="txtInvioceRef" CssClass="txtInput" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtInvoiceDate" CssClass="txtInput" runat="server"></asp:TextBox>
                                        ...
                                        <td align="left" style="width: 10%">
                                            <asp:TextBox ID="txtInvoiceAmount" CssClass="txtInput" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtTaxAmount" CssClass="txtInput" runat="server"></asp:TextBox>
                                        </td>
                                        <td align="right">
                                            Due Date:
                                        </td>
                                        <td align="left" style="width: 10%">
                                            <asp:TextBox ID="txtDueDate" CssClass="txtInput" runat="server"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" colspan="3">
                                            <asp:TextBox ID="txtRemarks" CssClass="txtInput" runat="server" TextMode="MultiLine"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="4">
                                            <asp:Button ID="btnUploadInvoice" runat="server" Text="Update Invoice Data" OnClick="btnUploadInvoice_Click" />
                                            <asp:Button ID="btnSubmit" runat="server" Text="Submit for payment" OnClick="btnSubmit_Click" />
                            ...
                            <div style="border: 1px solid #cccccc; font-family: Tahoma; font-size: 12px; width: 100%;">
                                <table id="DivStep4" runat="server" visible="false">
                                    <tr>
                                        <td align="left" style="color: #FF0000; font-size: small;" colspan="4">
                                            The below invoice has been rejected for the following reasons :
                                            <asp:Label ID="lblRejectReason" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                    ...
                                    <tr>
                                        <td colspan="4" align="left" style="color: #FF0000; font-size: small;">
                                            Please delete the file and re-upload the invoice again for us to process the invoice.
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:Button ID="btnRecallInvoice" runat="server" Text="Recall Invoice" OnClick="btnRecallInvoice_Click" />
                                        </td>
                                        <td align="left" colspan="3">
                                            <asp:Button ID="btnExit" runat="server" Text="Exit And Close" OnClick="btnExit_Click" />
                                        </td>
                                        <%--<td align="left">
                                            <asp:Button ID="btnUploadCreditNote" runat="server" Text="Upload Credit Note" />
                                        </td>--%>
                                    </tr>
                                </table>
                            </div>
                ...
                <div id="divIframe" runat="server" visible="false" style="border: 1px solid #cccccc;
                    height: 100%; font-family: Tahoma; font-size: 12px; width: 100%;">

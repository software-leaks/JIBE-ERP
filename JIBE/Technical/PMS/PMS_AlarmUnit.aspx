<%@ Page Title="Alarm Unit" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="PMS_AlarmUnit.aspx.cs" Inherits="Technical_PMS_PMS_AlarmUnit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ctl00_MainContent_txtModalUnit").value.trim() == "") {
                alert("Please enter a unit name.");
                document.getElementById("ctl00_MainContent_txtModalUnit").focus();
                return false;
            }
            return true;
        }
                                ...
                                <table width="100%" cellpadding="1" cellspacing="4">
                                    <tr>
                                        ...
                                        <td align="left" style="width: 30%">
                                            ...
                                            <ajaxToolkit:TextBoxWatermarkExtender ID="TBWE2" runat="server" TargetControlID="txtUnit"
                                        ...
                                        <td align="center" style="width: 5%">
                                            <asp:ImageButton ID="ImgAdd" runat="server" ToolTip="Add New Unit" OnClick="ImgAdd_Click"
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="GridViewcurrency" runat="server" EmptyDataText="NO RECORDS FOUND"
                                    AutoGenerateColumns="False" OnRowDataBound="GridViewcurrency_RowDataBound" DataKeyNames="UnitID"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Code" SortExpression="UnitName" HeaderStyle-HorizontalAlign="Center"
                                            HeaderStyle-Width="50%">
                                            <HeaderTemplate>
                                                <div style="padding-left: 30px;">
                                                    <asp:Label ID="lblCurrencyCodeHeader" runat="server" CommandName="Sort" CommandArgument="UnitID"
                                                        ForeColor="Black">Unit&nbsp;</asp:Label></div>
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <div style="padding-left: 20px;">
                                                    <asp:LinkButton ID="lblCurrencyCode" runat="server" CommandArgument='<%#Eval("UnitID")%>'
                                                        Text='<%# DataBinder.Eval(Container,"DataItem.UnitName") %>' Style="color: Black"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:ImageButton ID="ImgUpdate" runat="server" Text="Update" OnCommand="onUpdate"
                                                                Visible='<%# uaEditFlag %>' CommandArgument='<%#Eval("[UnitID]")%>' ForeColor="Black"
                                                        ...
                                                        <td>
                                                            <asp:ImageButton ID="ImgDelete" runat="server" Text="Delete" OnCommand="onDelete"
                                                                ...
                                                                CommandArgument='<%#Eval("[UnitID]")%>' ForeColor="Black" ToolTip="Delete" ImageUrl="~/Images/delete.png"
                                                                Height="16px"></asp:ImageButton>
                                                        </td>
                                                        <td>
                                                            <asp:Image ID="imgRecordInfo" ImageAlign="AbsMiddle" ImageUrl="~/Images/RecordInformation.png"
                                                                Height="16px" Width="16px" runat="server" onclick='<%# "Get_Record_Information(&#39;TEC_LIB_ALARM_UNIT&#39;,&#39;UnitID="+Eval("UnitID").ToString()+"&#39;,event,this)" %>' />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                ...
                                <uc1:ucCustomPager ID="ucCustomPagerItems" runat="server" PageSize="30" OnBindDataItem="BindUnit" />
                                <asp:HiddenField ID="HiddenFlag" runat="server" EnableViewState="False" />
                            </div>
                            <br />
                        </div>
                        <asp:Panel ID="pnladd" DefaultButton="btnsave" runat="server">
                            <div id="divadd" title="<%= OperationMode %>" style="display: none; border: 1px solid Gray;
                                ...
                                <table width="98%" cellpadding="2" cellspacing="2">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtModalUnit" CssClass="txtInput" MaxLength="50" Width="40%" runat="server"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" style="font-size: 11px; text-align: center; border-style: solid;
                                            ...
                                            <asp:TextBox ID="txtUnitID" runat="server" Visible="false" Width="1px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PMSCopyJobs.aspx.cs" Inherits="Technical_PMS_PMSCopyJobs"
    EnableEventValidation="false" Title="Copy Jobs" %>
...
<body >
    <script language="javascript" type="text/javascript">
        ...
        function ValidationOnOverWriteAppend(id, action) {
            ...
            if (FromVessel == "0") {
                alert("Please select From vessel."); return false;
            }

            if (ToVessel == "0") {
                alert("Please select To vessel."); return false;
            }

//            if (FromVessel == ToVessel) {
//                alert("From Vessel and to vessel can not be same."); return false;
//            }
...
//                alert("From System and to To system can not be same."); return false;
//            }
            ...
            if (FromSubsystem != "0") {
                ...
                if (ToSubsystem == "0") {
                    alert("Please select to subsystem."); return false;
                }
            }
            ...
            var strMsg = "Jobs will be " + document.getElementById(id).value + "\n\n"
                             + "from : \n"
        ...
        function ValidationOnOverWrite(id, action) {
            ...
            if ((FromVessel == ToVessel) && (FromDepartment == ToDepartment) && (FromSystem == ToSystem) && (FromSubsystem == ToSubsystem)) {

                alert("You Cannot Overwrite the Job when from fields and to fields are equal.");
                return false;
...
//                            }
    ...
    <div style="font-family: Tahoma; font-size: 12px;" >
        <div>
            <table cellpadding="1" cellspacing="1" style="border: 1px solid gray;width:850px;">
                <tr>
                    <td colspan="5">
                                ...
                                <div style="border: 1px solid gray; height: 170px">
                                    <table cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:DropDownList ID="DDLFromVessel" runat="server" AppendDataBoundItems="true" Width="260px"
                                                    AutoPostBack="True" OnSelectedIndexChanged="DDLFromVessel_SelectedIndexChanged">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:DropDownList ID="DDLFromDept" runat="server" AppendDataBoundItems="true" Width="260px"
                                                    OnSelectedIndexChanged="DDLFromDept_SelectedIndexChanged" AutoPostBack="True">
                                                    <asp:ListItem Selected="True" Value="0">--SELECT ALL--</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                ...
                                <div style="border: 1px solid gray; height: 170px">
                                    <table cellpadding="1" cellspacing="1">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:DropDownList ID="DDLToVessel" runat="server" AppendDataBoundItems="true" Width="260px"
                                                    AutoPostBack="True" OnSelectedIndexChanged="DDLToVessel_SelectedIndexChanged">
                                                    <asp:ListItem Selected="True" Value="0">--SELECT ALL--</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                <asp:DropDownList ID="DDLToDept" runat="server" AppendDataBoundItems="true" Width="260px"
                                                    AutoPostBack="True" OnSelectedIndexChanged="DDLToDept_SelectedIndexChanged">
                                                    <asp:ListItem Selected="True" Value="0">--SELECT ALL--</asp:ListItem>
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                ...
                <tr>
                    <td colspan="5" align="center" style="background-color: #CCCCCC">
                        <asp:Button ID="btnOverwrite" Text="Overwrite" runat="server" OnClientClick="return ValidationOnOverWrite(id,'Overwrite');"
                            OnClick="btnOverwrite_Click" />
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="btnAppend" Text="Append" runat="server" OnClientClick="return ValidationOnOverWriteAppend(id,'Append');"

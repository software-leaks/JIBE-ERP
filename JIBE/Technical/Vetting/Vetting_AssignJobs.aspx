<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vetting_AssignJobs.aspx.cs" Inherits="Technical_Vetting_Vetting_AssignJobs" %>
                    ...
                    <ContentTemplate>
                                    ...
                                    <div style="width: 100%; text-align: left; height: 400px;">
                                        <div id="Div2" style="border: 1px solid #aabbdd; background-color: #efefef; padding: 8px; 
                                            ...
                                            <div>
                                                <table cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="font-weight: bold; padding-right: 20px; font-size: 12px; font-family: Calibri;">
                                                        ...
                                                        <td style="font-weight: bold; padding-right: 20px; font-size: 12px; font-family: Calibri;">
                                                            <asp:RadioButtonList ID="rblJobStaus" runat="server" RepeatDirection="Horizontal"
                                                                ...
                                                                <asp:ListItem Value="VERIFY" Text="Verified"></asp:ListItem>
                                                                <asp:ListItem Value="OVERDUEPENDING" Text="Overdue"></asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </td>
                                                        <td style="text-align: left;">
                                                            <asp:TextBox ID="txtDescription" runat="server" Width="150px" Font-Size="12px"></asp:TextBox>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="divgrid">
                                            <asp:GridView ID="grdJoblist" runat="server" AutoGenerateColumns="false" CellPadding="4"
                                                ...
                                                <HeaderStyle CssClass="HeaderStyle-css Crew-HeaderStyle-css" Font-Bold="true" Font-Size="11px"
                                                    Font-Names="Tahoma" />
                                                <PagerStyle CssClass="PagerStyle-css" />
                                                <RowStyle CssClass="RowStyle-css" Font-Size="11px" Font-Names="Tahoma" />
                                                ...
                                                <EmptyDataRowStyle CssClass="emptyTemplateStyle" Font-Size="14px" Font-Names="Tahoma"  ForeColor="Red" Font-Bold="true"/>
                                            </asp:GridView>
                        ...
                        <div style="text-align: right">
                            <asp:Button ID="btnAssign" runat="server" Text="Assign" Style="margin-top: 10px;
                                width: 100px" OnClick="btnAssign_Click" Visible="false" Font-Size="12px" />
                            &nbsp;&nbsp;&nbsp;
                            <asp:Button ID="btnAssignandClose" runat="server" Text="Save" Style="margin-top: 10px;
                                width: 200px; height: 25px;" OnClick="btnAssignandClose_Click" Font-Size="12px" />
                            <asp:Button ID="btnGenerateReport" runat="server" Text="Generate Report" Style="margin-top: 10px;
                                width: 150px; margin-left: 10px; margin-right: 10px" OnClick="btnGenerateReport_Click" Font-Size="12px"
                                Visible="false" />
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>

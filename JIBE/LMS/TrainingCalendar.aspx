<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TrainingCalendar.aspx.cs" Title="Training Calendar" Inherits="LMS_Training_Calendar" %>
...
<head runat="server">
        ...
        function setup_calendar() {
            ...
            if ($("#calendar").length) {
                ...
                var calendar = $('#calendar').fullCalendar({
                    ...
                    editable: false,
                    eventSources: [{
                        url: '../UserControl/TrainingCalendar.ashx?J=TR&Dt=' + $('#calendar').fullCalendar('getDate').toString()
                    }],
    ...
    <style type="text/css">
        ...
        .DUE div span.fc-event-title
        {
            color: Yellow;
        }
        .OVERDUE div span.fc-event-title
        {
            color: Red;
        }
        .COMPLETED div span.fc-event-title
        {
        }
    </style>
</head>

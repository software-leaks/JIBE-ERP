<%@ Page Title=" Jibe: FAQ" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="LMS_Faq_List.aspx.cs" Inherits="LMS_LMS_Faq_List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        function ExportDivDataToExcel() {
            var html = $("#dvasyncFAQListFaq").html();
            html = $.trim(html);
            html = html.replace(/>/g, '&gt;');
            html = html.replace(/</g, '&lt;');
    ...
    <div style="margin-top: 2px; border: 1px solid #cccccc; vertical-align: bottom; padding: 2px;
        ...
        <table id="testTable" width="100%" cellpadding="1" style="margin-bottom: 10px">
            <tr>
                ...
                <td>
                    <input type="button" id="btnAddNewFAQ" title="Add New FAQ" onclick="window.open('LMS_FAQ_Builder.aspx');"
                        value="Add New FAQ" style="width: 90px"  />
                </td>
                <td>

<%@ Page Title="Noon Report At Port" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="NoonReport_Port.aspx.cs" Inherits="Operations_NoonReport_Port" %>
                                    ...
                                    <asp:FormView ID="fvnoonreport" runat="server" Width="100%">
                                        <ItemTemplate>
                                            <table width="90%" cellspacing="0">
                                                <tr>
                                                    <td valign="top" style="border: solid 1px gray" width="50%">
                                                        <table cellspacing="1" width="99%">
                                                            ...
                                                            <tr class='leafTR'>
                                                        <td class='leafTD-header'>
                                                            <table width="180px"  style="text-align:left;margin-left:-1px">
                                                            <tr>
                                                            <td>Current Direction from Chart:</td>
                                                            </tr>
                                                            </table>
                                                        ...
                                                        <td class='leafTD-header'>
                                                        <table width="180px"  style="text-align:left;margin-left:-1px">
                                                        <tr><td>Current Speed from Chart:</td></tr>
                                                        </table>
                                                    ...
                                                    <td valign="top" style="border: solid 1px gray" width="99%">

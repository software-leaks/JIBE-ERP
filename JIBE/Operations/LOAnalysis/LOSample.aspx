<%@ Page Title="Lube Oil Sample Analysis" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="LOSample.aspx.cs" Inherits="Operations_LOSample" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#dialog').dialog({
                ...
                buttons: {
                    ...
                    "Reload": function () {
                        var url = "LOAttachments.aspx?id=" + $('#dialog').attr('alt') + "&rnd=" + Math.random();
        ...
        function showAttachments(ID, Type) {
            var url = "LOAttachments.aspx?id=" + ID + "&Type=" + Type + "&rnd=" + Math.random();
            showDiv('dvAttachments', url)
        }
        function showWorklist(WL_OfficeID, Vessel_id) {
            var url = "../../Technical/worklist/ViewJob.aspx?OFFID=" + WL_OfficeID + "&VID=" + Vessel_id + "&WLID=0";
            window.open(url);
        }
    ...
    <script type="text/javascript">
        function positionOffllandPanel() {

           var a = document.getElementById('ctl00_MainContent_ctlBunkerPort_pnlSearch');// 
           if (a) {
               a.style.zIndex = "500";
 ...
 <asp:UpdateProgress ID="upUpdateProgress" DisplayAfter="1" runat="server">
    ...
    <div id="dvMain" style="border-left: 1px solid #cccccc; border-right: 1px solid #cccccc;
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlLabList" runat="server" Width="156px" AppendDataBoundItems="true"
                                        AutoPostBack="true" DataTextField="LAB_NAME" DataValueField="ID" OnSelectedIndexChanged="ddlLabList_SelectedIndexChanged">
                                ...
                                <td>
                                    <uc:PortList ID="ctlBunkerPort" runat="server" OnSelectedIndexChanged="ctlBunkerPort_SelectedIndexChanged" />
                                </td>
                                <td>
                                    Report Status
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlBunkerSupplier" runat="server" Width="156px" AppendDataBoundItems="true"
                                        DataTextField="SUPPLIER_NAME" DataValueField="ID" AutoPostBack="true" OnSelectedIndexChanged="ddlBunkerSupplier_SelectedIndexChanged">
                                        <asp:ListItem Text="-SELECT ALL-" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td>
                                ...
                                <td>
                                    <asp:TextBox ID="txtAirwayBill" runat="server" AutoPostBack="true" OnTextChanged="txtAirwayBill_TextChanged"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlStatus" runat="server" Width="156px" AutoPostBack="true"
                                        OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                                        <asp:ListItem Text="-SELECT ALL-" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Within Spec" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Out-Of-Spec" Value="2"></asp:ListItem>
                                        <asp:ListItem Text="Caution Level" Value="3"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                                <td style="text-align: right">
        ...
        <div id="grid-container" style="margin-top: 5px; border: 1px solid #cccccc; padding: 2px;
            ...
            <asp:UpdatePanel ID="UpdatePanel_Bunker" runat="server">
                <ContentTemplate>
                    <asp:GridView ID="GridView_Bunker" runat="server" CellPadding="1" EmptyDataText="No record found!"
                      ...
                      <HeaderStyle CssClass="HeaderStyle-css" Height="25px" />
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="L.O Category" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Offlanded Date" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="L.O. Supplier" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    ...
                                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Get_LOSupplierList"
                            ...
                            <asp:TemplateField HeaderText="Lab" HeaderStyle-HorizontalAlign="Left">
                                ...
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlLabName" runat="server" Width="200px" AppendDataBoundItems="true"
                                        DataTextField="LAB_NAME" DataValueField="ID"  DataSourceID="ObjectDataSource2">
                                        <asp:ListItem Text="-SELECT-" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:HiddenField ID="hdnLabID" runat="server" ClientIDMode="Static"  Value='<%# Bind("LabID")%>' />
                                    <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" SelectMethod="Get_LOTestingLabList"
                                        TypeName="SMS.Business.Operation.BLL_OPS_BunkerAnalysis">
                                        <SelectParameters>
                                            <asp:SessionParameter DefaultValue="0" Name="UserID" SessionField="USERID" Type="Int32" />
                                        </SelectParameters>
                            ...
                            <asp:TemplateField HeaderText="Worklist" HeaderStyle-HorizontalAlign="Left">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkWorklist" runat="server" Text='<%# Eval("WL_Job_Status")%>'
                                        OnClientClick='<%# "showWorklist(" + Eval("wl_office_id").ToString() + "," + Eval("vessel_id").ToString() + ")" %>'>
                                    </asp:LinkButton>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
                                <ItemStyle Width="100px" HorizontalAlign="Left" />
                            ...
                            <asp:TemplateField HeaderText="Received By Lab" HeaderStyle-HorizontalAlign="left">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Report" HeaderStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkAddReport" runat="server" Text="Upload" Visible='<%# !Convert.ToBoolean(Eval("ReportCount")) %>'
                                        OnClientClick='<%# "showAttachments(" + Eval("ID").ToString() + ",1)" %>'>
                                    </asp:LinkButton>
                            ...
                            <asp:TemplateField HeaderText="Attachments" HeaderStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                    ...
                    <uc1:ucCustomPager ID="ucCustomPager" runat="server" RecordCountCaption="&nbsp;&nbsp;&nbsp;&nbsp;Total Records" PageSize="30"
                        AlwaysGetRecordsCount="true" OnBindDataItem="Load_BunkerSampleAnalysis" />
                </ContentTemplate>
            </asp:UpdatePanel>
        </div>
    </div>
    ...
    <div id="dvAttachments" class="draggable" style="display: none; background-color: #CBE1EF;
        ...
        <div class="popup-header">
            ...
            <h4>
                Lube Oil Sample Attachments</h4>
        </div>

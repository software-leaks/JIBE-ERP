<%@ Page Title="Lube Oil Sample Analysis" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="LOSampleLab.aspx.cs" Inherits="Operations_LOSampleLab" %>
  ...
  <div class="page-title">
        Lube Oil Sample Analysis
         <div style="float: right; display: none;">
            <asp:ImageButton ID="ImageButton2" ImageUrl="../../Images/Excel-icon.png" Height="20px"
                    ...
                    <asp:Panel ID="pnlFilter" runat="server" DefaultButton="btnSearch">
                        <table border="0" cellpadding="0" cellspacing="4" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">
                                    <asp:Button ID="Button1" runat="server" ToolTip="Clear Filter" OnClick="BtnClearFilter_Click" Text="Clear Filter"
                                        Width="80px" CssClass="btnCSS" />
                                </td>
                            </tr>
                        </table>
    ...
    <div id="dvAttachments" class="draggable" style="display: none; background-color: #CBE1EF;
        ...
        <div class="popup-header">
            ...
            <h4>
                Lube Oil Analysis Attachments</h4>
        </div>

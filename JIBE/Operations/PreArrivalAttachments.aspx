<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PreArrivalAttachments.aspx.cs"
    Inherits="Operations_PreArrivalAttachments" Title="Pre Arrival Attachemnts" %>
                                ...
                                <asp:GridView ID="gvInspectionAttachment" runat="server" AutoGenerateColumns="False"
                                   ...
                                   <Columns>
                                        <asp:TemplateField HeaderText="Attachment name" HeaderStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                &nbsp;&nbsp;&nbsp;<a href='<%#"../Uploads/PreArrivalAttachments/"+System.IO.Path.GetFileName(Convert.ToString(Eval("File_Path")))%>'
                                                    target="_blank"><asp:Label ID="lblAttName" runat="server" Text='<%# Eval("File_Name").ToString() %>'></asp:Label></a>
                                            </ItemTemplate>
                                        </asp:TemplateField>                                       
                                    </Columns>
                                </asp:GridView>

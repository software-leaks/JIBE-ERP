<%@ Page Title="Arrival Report" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Arrival_Report.aspx.cs" Inherits="Operations_Arrival_Report" %>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 100%; height: 120px; background-color: #cce499">
                                                                        <asp:TextBox ID="txtremark" runat="server" BackColor="#cce499" BorderStyle="None"
                                                                            ...
                                                                            Width="1175px" ReadOnly="true" Enabled="false" CssClass="TBRemark"> </asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>

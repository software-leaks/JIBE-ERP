<%@ Page Title="Invoice Summary Report" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="PO_Log_Invoice_Summary.aspx.cs" Inherits="PO_LOG_PO_Log_Purchasing_Report" %>
            ...
            <div id="page-title" class="page-title">
                ...
                <div style="padding-top: 5px; border: 1px padding-bottom: 5px;">
                    ...
                    <tr>
                      ...
                      <td align="right" style="width: 10%">
                            ...
                            <td align="left" style="width: 10%">
                                  <asp:DropDownList ID="ddlVessel" runat="server" CssClass="txtInput" Width="300px">
                                </asp:DropDownList></td></td>
                   
                                <td align="right" style="width: 10%">
                                 Owner  :</td>
                            <td align="left" style="width: 25%">
                                <asp:DropDownList ID="ddlOwner" runat="server" CssClass="txtInput" Width="300px">
                                </asp:DropDownList></td>
                  ...
                  <tr>
                   ...
                   <td style="width: 10%"  align="right">
                    ...
                    <td align="left"  style="width: 25%;">
                     <%--  <asp:DropDownList ID="ddlStatus" runat="server" CssClass="txtInput" Width="300px">
                       <asp:ListItem Value="POStatus" >PO without Invoice</asp:ListItem>
                         <asp:ListItem Value="UnpaidInvoiceStatus">Invoice Received and Unpaid</asp:ListItem>
                           <asp:ListItem Value="InvoiceStatus">Invoice Paid</asp:ListItem>
                                </asp:DropDownList>--%>
                       <asp:CheckBox ID="chkPO" runat="server" Text="PO without Invoice" />
                                        <asp:CheckBox ID="chkUnpaidInvoice" runat="server" Text="Invoice Received and Unpaid" />
                                        <asp:CheckBox ID="chkInvoice" runat="server" AutoPostBack="true" 
                            Text="Invoice Paid" oncheckedchanged="chkInvoice_CheckedChanged" />
                         </td>
                          <td style="width: 10%"  align="right">
                              Payment Between  : &nbsp;
                            </td>
                    <td align="left"  style="width: 10%;">
                       <asp:TextBox ID="txtFromPayment" runat="server" CssClass="txtInput" Width="120px"></asp:TextBox>
                         <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="txtFromPayment"
                                        Format="dd/MM/yyyy">  </ajaxToolkit:CalendarExtender>
                         <asp:TextBox ID="txtToPayment" runat="server" CssClass="txtInput" Width="120px"></asp:TextBox>
                           <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" TargetControlID="txtToPayment"
                                        Format="dd/MM/yyyy">  </ajaxToolkit:CalendarExtender>
                         </td>
                    ...
                    <tr>
                         <td style="width: 100%; color:Blue;" colspan="8"  align="right">
                             This report excludes Owners expenses that will be deducted against hire.
                            </td>
               ...
               <div id="divPurchase"  runat="server" style="margin-left: auto;
                    ...
                    <asp:GridView ID="gvPurchase" runat="server" EmptyDataText="NO RECORDS FOUND"
                        ...
                        Width="100%" GridLines="both"  AllowSorting="true"  ShowFooter="True"  
                                  onrowdatabound="gvPurchase_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Supplier Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblSupplier_Display_Name" runat="server" Text='<%#Eval("Supplier_Display_Name")%>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Cur">
                                <ItemTemplate>
                                 ...
                                 <FooterTemplate>
                                  <table width="100%"  >
                                   <tr><td align="right">
                                    <asp:Label ID="lblPOTotal" runat="server" Text="PAGETotal (USD)" /><br /><br /></td></tr>
                             ...
                             <asp:TemplateField HeaderText="USD Value">
                                <ItemTemplate>
                                   <asp:Label ID="lblPO_USD_Amount" runat="server" Text='<%#Eval("PO_USD_Amount","{0:N2}")%>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                  <table width="100%"  >
                                   <tr><td align="right">
                                    <asp:Label ID="lblPOUSDAmount" runat="server"  /><br /><br /></td></tr>
                                   <tr><td align="right"><asp:Label ID="lblPOUSDAmount1" runat="server"  Font-Bold="true" /></td></tr>
                                   </table>
                                    </FooterTemplate>
                                <ItemStyle Wrap="true" HorizontalAlign="Right" Width="4%" CssClass="PMSGridItemStyle-css">
                                </ItemStyle>
                            ...
                            <asp:TemplateField HeaderText="Reference">
                             ...
                             <asp:TemplateField HeaderText="Status">
                              ...
                              <asp:TemplateField HeaderText="Currency">
                                <ItemTemplate>
                                 ...
                                 <FooterTemplate>
                                   <table width="100%"  >
                                   <tr><td align="right">
                                    <asp:Label ID="lblInvoiceTotal" runat="server" Text="PAGETotal(USD)" /><br /><br /></td></tr>
                                   <tr><td align="right"><asp:Label ID="lbl1345" runat="server" Text="Total in USD(TotalRecord)" Font-Bold="true" /></td></tr>
                                   </table>
                                    </FooterTemplate>
                                <ItemStyle Wrap="true" HorizontalAlign="Center" Width="3%" CssClass="PMSGridItemStyle-css">
                                </ItemStyle>
                              ...
                              <asp:TemplateField HeaderText="USD Amount">
                                <ItemTemplate>
                                    <asp:Label ID="lblInvoice_Book_Value" runat="server" Text='<%#Eval("Invoice_Book_Value","{0:N2}")%>'></asp:Label>
                                </ItemTemplate>
                                 <FooterTemplate>
                                  <table width="100%"  >
                                   <tr><td align="right">
                                    <asp:Label ID="lblInvBookValue" runat="server"  /><br /><br /></td></tr>
                                   <tr><td align="right"><asp:Label ID="lblInvBookValue1" runat="server"  Font-Bold="true" /></td></tr>
                                   </table>
                                    </FooterTemplate>
                                <ItemStyle Wrap="true" HorizontalAlign="Right" Width="4%" CssClass="PMSGridItemStyle-css">
                                </ItemStyle>
                             ...
                             <asp:TemplateField HeaderText="Status">
                                <ItemTemplate>
                                    <asp:Label ID="lblInvoice_PAYMENT_STATUS" runat="server" Text='<%#Eval("Invoice_PAYMENT_STATUS")%>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle Wrap="true" HorizontalAlign="Center" Width="4%" CssClass="PMSGridItemStyle-css">
                                </ItemStyle>
                                <HeaderStyle Wrap="true"  HorizontalAlign="Center" />
                            ...
                            <asp:TemplateField visible="False" HeaderText="Action">
                                ...
                                <ItemTemplate>
                                <asp:ImageButton ID="ImgCompare" runat="server" visible="False" ForeColor="Black" Width="18px" Height="12px"

    ...
    a.extend(a.jqx._jqxTreeGrid.prototype, {
        ...
        _renderrows: function () {
            ...
            if (D === 0) {
                ...
                var av = '<td colspan="' + N.columns.records.length + '" role="gridcell" style="border-right-color:#F0FFFF; min-height: ' + q + "px; height: " + q + "px;  min-width:" + aq + "px; max-width:" + aq + "px; width:" + aq + "px;";
            ...
            for (var Q = 0; Q < v.length; Q++) {
                ...
                for (var P = 0; P < b; P++) {
                    ...
                    var aj = '<td role="gridcell"' + R + ' style="pointer-events: none; visibility: hidden; border-color: #F0FFFF; max-width:' + aw + "px; width:" + aw + "px;";
                    if (P == b - 1 && b == 1) {
                        av += "border-right-color: #F0FFFF;";
                        aj += "border-right-color: #F0FFFF;"
                    }

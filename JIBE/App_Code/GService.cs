...
public class GService : System.Web.Services.WebService
{
    ...
    {
        string filePath = Server.MapPath("ShipImages/" + sImageText + ".png");
        ...
        if (!File.Exists(filePath))
        {
            ...
            Font MyFont = new Font("Arial", 6, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point);
            ...
            MyGraphics.DrawString(sImageText, MyFont, new SolidBrush(Color.Blue), 0, 0);
            MyGraphics.Flush();

            WriteImage(sImageText, bmpImage);
        }
    }

...
public class GoogleObject
{
    ...
    string _width = "900px";  //original 500
    public string Width
    {
        get
        {
    ...
    string _height = "600px"; //original 400
...
public class GooglePoint
{
    ...
    public string IconImage
    {
        ...
        set
        {
            ...
            if (sIconImage == "")
                return;
            string ImageIconPhysicalPath = cCommon.GetLocalPath() + "ShipImages\\" + sIconImage.Replace("/", "\\");
            ...
            //_icon = cCommon.GetHttpURL() + "ShipImages" + "/" + sIconImage;
            _icon = value;
        }
    }

...
// Componente: PopCalendarAjaxNet.js(1.0.3)
...
{
	var objPopCalList=[]
	var PopCalendar={majorVersion:1,minorVersion:0.3,newCalendar:new Function("_name","return(PopCalGetCalendarInstance(_name))")}
}

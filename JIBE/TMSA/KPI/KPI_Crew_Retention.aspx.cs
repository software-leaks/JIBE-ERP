...
public partial class Crew_Retention : System.Web.UI.Page
{
    ...
    private void LoadData()
    {
        ...
        else
        {
            ...
            string funtion = "$(document).ready(function () {showChart();})";
                ...
                for (int j = 0; j < tblCols; j++)
                {
                    ...
                    if (iCount < rowcount)
                    {
                        TableCell tc = new TableCell();
                            ...
                            newControl.Attributes.Add("Style", "Height:300px;width:700px;float:left;border-style: solid;");

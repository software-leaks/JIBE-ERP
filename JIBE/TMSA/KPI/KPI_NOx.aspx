<%@ Page Title="KPI -NOx Efficiency" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" EnableEventValidation="false" CodeFile="KPI_NOx.aspx.cs"
    Inherits="KPI_NOx" %>
                    ...
                    [
                        {
                            ...
                            series: [
                                    { dataField: 'Average', displayText: 'NOx Effeciency ' }
    ...
    <script type="text/javascript">
        ...
        function showChart2(telId1, telId2, startdate, enddate, vesselname, vesselId, voyage, selectedVoyage) {
                    ...
                    var source =
            {
                ...
                url: "../../KPIService.svc/GetVoyageDataNOx/VID/" + vesselId + "/Startdate/" + startdate + "/EndDate/" + enddate + "/telId1/" + telId1 + "/telId2/" + telId2
               // url: "../../KPIService.svc/GetDataNOx/VID/" + vesselId + "/Startdate/" + convertDate(document.getElementById("ctl00_MainContent_hiddenStartDate").value) + "/EndDate/" + convertDate(document.getElementById("ctl00_MainContent_hiddenEndDate").value)
            };
        }
        ...
        showChart();
                var source =
            {
                ...
                datafields: [
                 ...
                 // url: "../../KPIService.svc/GetDataNOx/VID/" + vesselId + "/Startdate/" + convertDate(document.getElementById("ctl00_MainContent_hiddenVesselStartDate").value) + "/EndDate/" + convertDate(document.getElementById("ctl00_MainContent_hiddenVesselEndDate").value)
                url: "../../KPIService.svc/GetDataNOx/VID/" + vesselId + "/Startdate/" + startdate + "/EndDate/" + enddate 
              };
            ...
            //    var selector = '#chartContainer2' + i;
            $('#chartContainer2').jqxChart(settings);
        ...
        function showChart() {
            ...
            NOx_Object.Vessel_Id = hdn;
            NOx_Object.Start_date = convertDate(document.getElementById("ctl00_MainContent_hiddenSDate").value);
            NOx_Object.End_date = convertDate(document.getElementById("ctl00_MainContent_hiddenEDate").value);
            var sendurl = "../../KPIService.svc/GetMultipleVesselDataNOx";
            $.ajax({
                type: "POST",
                url: sendurl,
                data: JSON.stringify(NOx_Object),
                    ...
                    [
                        {
                            ...
                            series: [
                                    { dataField: 'AVERAGE', displayText: 'NOX Efficiency ' }
                                ]
                        },
...
//        function ConvertDt_oldFormat(strDate) {
                        ...
                        <telerik:RadGrid ID="rgdItems" runat="server" AllowAutomaticInserts="True" GridLines="None"
                            ...
                            <MasterTableView EditMode="InPlace" ClientDataKeyNames="Vessel_Id,Vessel_Name">
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn AllowFiltering="false" HeaderStyle-Width="150px" HeaderText="NOx Efficiency" HeaderStyle-HorizontalAlign="Center"
...
<%--                                     <input type="button" class="buttonnew" id="btnVoyageChart" title="Show Chart" runat="server"
                            visible="false" onclick="getDataToList();" style="width: 23px; " />--%>

<%@ Page Title="Vessel NOx Efficiency" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="Vessel_NOx_Efficiency.aspx.cs" Inherits="TMSA_KPI_Vessel_CO2_Efficiency" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function validateFrequency(_id, _vid) {
            ...
            if (_id != "") {
                var sendurl = "../../KPIService.svc/GetTelDateNOx";
                        ...
                        var source =
            {
                ...
                localdata: objData
                        ...
                        //                            return 'Date :' + xAxisValue.getDate() + '-' + months[xAxisValue.getMonth()] + '-' + xAxisValue.getFullYear() + "</br>" + serie.dataField + ':' + Number(value).toFixed(2);
                        //                        }
                        var settings = {
        ...
        function showChart() {
            ...
            var source =
            {
                ...
                url: "../../KPIService.svc/GetDataNOx/VID/" + document.getElementById("ctl00_MainContent_hiddenVessel").value + "/Startdate/" + convertDate(document.getElementById("ctl00_MainContent_hiddenStartDate").value) + "/EndDate/" + convertDate(document.getElementById("ctl00_MainContent_hiddenEndDate").value)
            };
                ...
                seriesGroups:
                    [

                         {
                             ...
                             toolTipFormatFunction: toolTipCustomFormatFn,
                             series: [
                              { dataField: 'VALUE', displayText: 'NOx Efficiency' }
                                ]
                         }
            ...
            if ((document.getElementById("ctl00_MainContent_hiddenVessel").value != '-1') && (document.getElementById("ctl00_MainContent_txtStartDate").value.length != '0') && (document.getElementById("ctl00_MainContent_txtEndDate").value.length != '0')) {
                ...
                alert("Search query is Incorrect");
            }
        };
                    ...
                    <tr>
                        ...
                        <td valign="middle" align="center" width="30%">
                            ...
                            <asp:ImageButton ID="btnportfilter" runat="server" ToolTip="Search" ValidationGroup="Group1"
                                ImageUrl="~/Images/SearchButton.png" OnClick="btnportfilter_Click" OnClientClick="return validateDate();" />&nbsp;
                      ...
                      <td   valign="top">
                            <div id="divGrid" runat="server" title="Data" style="vertical-align: top;">
                                <asp:GridView ID="gvSearch" runat="server" EmptyDataText="No records to display."
                                    ...
                                    Width="100%" ShowFooter="True" OnRowDataBound="gvSearch_RowDataBound" OnPageIndexChanging="gvSearch_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="NOx Efficiency">
                                            <ItemTemplate>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td valign="top" align="left">
                                            <asp:Label ID="lblPIList" Text="PI List" runat="server" Font-Bold="true" BackColor="LightGray"  Width="200px"></asp:Label><br />

...
public partial class KPI_NOx : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            hiddenSDate.Value = UDFLib.ConvertToDefaultDt(txtStartDate.Text);
            hiddenEDate.Value = UDFLib.ConvertToDefaultDt(txtEndDate.Text);
            BindFleetDLL();
    ...
    protected void loadPIDetails()
    {
        try
        {
            ...
            if (dtKPI.Rows.Count > 0 && dtKPI.Rows[0]["KPI_ID"] != null)
    ...
    public void item_click(object sender, EventArgs e)
    {
        try
        {
            ...
            hiddenVesselStartDate.Value = txtStartDate.Text;
            hiddenVesselEndDate.Value = txtEndDate.Text;

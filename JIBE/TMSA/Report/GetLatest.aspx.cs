...
public partial class TMSA_Report_GetLatest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataSet dsFileDetails = objQMS.getFileDetailsByID(int.Parse(fileID), int.Parse(DocVersion));
        ...
        if (dsFileDetails.Tables[0].Rows.Count > 0)
        {
            ...
            OpenFileExternal("../JIBE/QMS/" + navURL, fileName);
        }
    }
    ...
    public void OpenFileExternal(string url, string fileName)
    {
        ...
        //string webRootPath1 = Server.MapPath("~");
        //string docPath = Path.GetFullPath(Path.Combine(webRootPath1, "/Documents/MyDocument.xml"));
        string webRootPath = Server.MapPath("~");
        string filepath = Path.GetFullPath(Path.Combine(webRootPath, url));

                ...
                <div class="toolbox">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlCatalog" runat="server" OnSelectedIndexChanged="ddlCatalog_SelectedIndexChanged" Width="200px" AutoPostBack="true">
                                </asp:DropDownList>
                                <asp:Button ID="btnLogin" runat="server" Width="80px" Text="LogIn" 
                                    OnClientClick="return ValidateCatalog();" OnClick="btnLogin_Click" 
                                    style="height: 26px" />
                            </td>
                        </tr>
                        <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCommandType" runat="server" Width="260px">
                                <asp:ListItem Text="TMSA PI Daemon SP" Value="TMSA_Daemon_SP"></asp:ListItem>
                                <asp:ListItem Text="TMSA KPI Daemon SP" Value="TMSA_KPI_Daemon_SP"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>

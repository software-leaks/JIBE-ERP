<%@ Page Title="Internal Inspections" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Internal_Inspections.aspx.cs" Inherits="TMSA_WorklistReport_Internal_Inspections" %>
...
.body-devide ul li:nth-of-type(3){width:100%; margin-left:20px; }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            showIntrInspNCRYearlyChart();
            showIntrInspNCRYearlyGrid();

            showIntrInspJobsYearlyGrid();
            showIntrInspJobsYearlyChart();
            ...
            $("input[name=tabs]:radio").click(function () {
                if ($(this).val() === 'tab2') {
                    ...
                    showIntrInspNCRMonthlyChart();
                    showIntrInspNCRMonthlyGrid();
                    showIntrInspJobsMonthlyGrid();
                    showIntrInspJobsMonthlyChart();
    ...
    <%--Method to bind YEAR dropdown--%>
        ...
        function showIntrInspNCRYearlyGrid() {  //done
           //Fetch the list of selected vessel
            ...
            $.ajax({
                ...
                processdata: true,
                async: false,
                success: showIntrInspNCRYearlyGrid_OnSuccess,
                error: function () {
        ...
        function showIntrInspNCRYearlyGrid_OnSuccess(data, status, jqXHR) {
        //Assign CSS to grid header
            ...
            var dataAdapter = new $.jqx.dataAdapter(source);
            $("#IntrInsp_NCR_YearlyGrid").jqxGrid(
                {
                    enablehover:true,
                    autoheight: true,
                    width:1000,
    ...
    function showIntrInspNCRYearlyChart() {     //done
        //Fetch the list of selected vessel
        var checkedItems = "";
        var items = $("#jqxVessel").jqxDropDownList('getCheckedItems');
        $.each(items, function (index) {
        ...
        Object1.Type = "NCR_INTERNAL";                //Pass type to service
        ...
        $.ajax({
            ...
            processdata: true,
            async: false,
            success: showIntrInspNCRYearlyChart_OnSuccess,
            error: function () {
                alert("An error occured");
            }
    ...
    function showIntrInspNCRYearlyChart_OnSuccess(data, status, jqXHR) {                   
            var seriesArray2 = [];
            var seriesArray1 = [];
            var items = $("#jqxVessel").jqxDropDownList('getCheckedItems');
            $.each(items, function (index) {
            ...
            var settings = {
                ...
                title: 'Internal Inspections - NCRs',
                description: "",
            ...
            $('#IntrInsp_NCR_YearlyChart').jqxChart(settings);
        }


<%-- Method to bind Gridview on the basis of YEAR and VESSEL values from dropdown--%>
        function showIntrInspJobsYearlyGrid() { //done
           //Fetch the list of selected vessel
            var checkedItems = "";
            var items = $("#jqxVessel").jqxDropDownList('getCheckedItems');
            $.each(items, function (index) {
            ...
            $.ajax({
                ...
                processdata: true,
                async: false,
                success: showIntrInspJobsYearlyGrid_OnSuccess,
                error: function () {
                    alert("An error occured");
                }
        ...
        function showIntrInspJobsYearlyGrid_OnSuccess(data, status, jqXHR) {
        //Assign CSS to grid header
             var columnsrenderer = function (value) {
                return '<div style="text-align: left; padding-top: 5px; padding-left:8px; padding-bottom:5px; font-size:14px;background-color:#d9d9d9;">' + value + '</div>';
            }
            ...
            var dataAdapter = new $.jqx.dataAdapter(source);
            $("#IntrInsp_Jobs_YearlyGrid").jqxGrid(
                {
                    enablehover:true,
                    autoheight: true,
                    width:1000,
        ...
        function showIntrInspJobsYearlyChart() {
        //Fetch the list of selected vessel
        var checkedItems = "";
        var items = $("#jqxVessel").jqxDropDownList('getCheckedItems');
        $.each(items, function (index) {
        ...
        $.ajax({
            ...
            processdata: true,
            async: false,
            success: showIntrInspJobsYearlyChart_OnSuccess,
            error: function () {
                alert("An error occured");
            }
    ...
    function showIntrInspJobsYearlyChart_OnSuccess(data, status, jqXHR) {                   
            var seriesArray2 = [];
            var seriesArray1 = [];
            var items = $("#jqxVessel").jqxDropDownList('getCheckedItems');
            $.each(items, function (index) {
            ...
            var settings = {
                borderLineColor: 'white',
                title: 'Internal Inspections - Worklist Jobs',
                description: "",
                enableAnimations: true,
                showLegend: true,
                padding: { left: 20, top: 0, right: 50, bottom: 5 },
            ...
            $('#IntrInsp_Jobs_YearlyChart').jqxChart(settings);
        }

    <%-- Method to bind Chart/Graph on the basis of YEAR and VESSEL values from dropdown--%>
    function showIntrInspNCRMonthlyChart() {    //done
    ...
    //Fetch the list of selected vessel
        ...
        $.ajax({
            ...
            processdata: true,
            async: false,
            success: [showIntrInspNCRMonthlyChart_OnSuccess],
            error: function () {
                alert("An error occured");
            }
    ...
    function showIntrInspNCRMonthlyChart_OnSuccess(data, status, jqXHR) {                   
            var seriesArray2 = [];
            var seriesArray1 = [];
            var items = $("#jqxVesselTab2").jqxDropDownList('getCheckedItems');
            $.each(items, function (index) {
            ...
            $('#IntrInsp_NCR_MonthlyChart').jqxChart(settings);
        }
...
function showIntrInspNCRMonthlyGrid() { //done
            //Fetch the list of selected vessel
            var checkedItems = "";
            var items = $("#jqxVesselTab2").jqxDropDownList('getCheckedItems');
            $.each(items, function (index) {
...
//            var selectedYear = item2.value;
           ...
           var checkedYears = "";
            ...
            Object.Type = "NCR_INTERNAL";
            Object.Vessel_IDs = checkedItems;
            Object.YEAR = checkedYears.replace(/(^,)|(,$)/g, "");
            ...
            $.ajax({
                ...
                processdata: true,
                async: false,
                success: showIntrInspNCRMonthlyGrid_OnSuccess,
                error: function () {
                    alert("An error occured");
                }
        ...
        function showIntrInspNCRMonthlyGrid_OnSuccess(data, status, jqXHR) {
        //Assign CSS to grid header
             var columnsrenderer = function (value) {
                return '<div style="text-align: left; padding-top: 5px; padding-left:8px; padding-bottom:5px; font-size:14px;background-color:#d9d9d9;">' + value + '</div>';
            }
            ...
            var dataAdapter = new $.jqx.dataAdapter(source);
            $("#IntrInsp_NCR_MonthlyGrid").jqxGrid(
                {
                    enablehover:true,
                    autoheight: true,
                    width:750,
...
//                ],
    ...
    <%-- Method to bind Chart/Graph on the basis of YEAR and VESSEL values from dropdown--%>
    function showIntrInspJobsMonthlyChart() {   //done
        ...
        $.ajax({
            ...
            processdata: true,
            async: false,
            success: [showIntrInspJobsMonthlyChart_OnSuccess],
            error: function () {
                alert("An error occured");
            }
    ...
    function showIntrInspJobsMonthlyChart_OnSuccess(data, status, jqXHR) { 
            ...
            $('#IntrInsp_Jobs_MonthlyChart').jqxChart(settings);
        }

//Script to populate Port State Control - Monthly Jobs

     function showIntrInspJobsMonthlyGrid() {   //done
...
//            var selectedYear = item2.value;
            ...
            $.ajax({
                ...
                processdata: true,
                async: false,
                success: showIntrInspJobsMonthlyGrid_OnSuccess,
                error: function () {
                    alert("An error occured");
                }
        ...
        function showIntrInspJobsMonthlyGrid_OnSuccess(data, status, jqXHR) {
        //debugger
        //Assign CSS to grid header
             var columnsrenderer = function (value) {
                return '<div style="text-align: left; padding-top: 5px; padding-left:8px; padding-bottom:5px; font-size:14px;background-color:#d9d9d9;">' + value + '</div>';
            ...
            var dataAdapter = new $.jqx.dataAdapter(source);
            $("#IntrInsp_Jobs_MonthlyGrid").jqxGrid(
                {
                    enablehover:true,
                    autoheight: true,
                    width:750,
    ...
    <div class="tabcontent" id="divTab">
        <ul class="tabs">
            <li>
                ...
                <label for="tab1">
                    Internal Inspections - yearly</label>
                <div id="tab-content1" class="tab-content animated fadeIn">
                    <div>
                        ...
                        <div class="body-devide">
                            <ul>
                                <li>
                                    <div id="IntrInsp_NCR_YearlyChart" style="width: 100%; height: 300px; float: left;">
                                    </div>
                                </li>
                                <li>&nbsp;</li>
                                <li>
                                    <div id="IntrInsp_NCR_YearlyGrid">
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="body-devide">
                            <ul>
                                <li>
                                    <div id="IntrInsp_Jobs_YearlyChart" style="width: 100%; height: 300px; float: left;">
                                    </div>
                                </li>
                                <li>&nbsp;</li>
                                <li>
                                    <div id='jqxWidget' style="width: 100%; float: left;">
                                        <div id="IntrInsp_Jobs_YearlyGrid">
                                        </div>
                                    </div>
                                </li>
                            </ul>
            ...
            <li>
                ...
                <label for="tab2">
                    Internal Inspections - Monthly</label>
                ...
                <div id="tab-content2" class="tab-content animated fadeIn">
                    ...
                    <div class="body-devide">
                        <ul>
                            <li>
                                <div id="IntrInsp_NCR_MonthlyChart" style="width: 100%; height: 300px; float: left;">
                                </div>
                            </li>
                            <li>&nbsp; </li>
                            <li>
                                <div id="IntrInsp_NCR_MonthlyGrid" style="width: 100%; height: 300px; float: left;">
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="body-devide">
                        <ul>
                            <li>
                                <div id="IntrInsp_Jobs_MonthlyChart" style="width: 100%; height: 300px; float: left;">
                                </div>
                            </li>
                            <li>&nbsp;</li>
                            <li>
                                <div id="IntrInsp_Jobs_MonthlyGrid">
                                </div>
                            </li>
                        </ul>
                    </div>

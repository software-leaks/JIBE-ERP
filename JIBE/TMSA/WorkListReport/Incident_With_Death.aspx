<%@ Page Title="Incidents With Death" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Incident_With_Death.aspx.cs" Inherits="TMSA_WorklistReport_Incident_With_Death" %>
...
<script type="text/javascript"><%-- Method to bind Incident count to Gridview on the basis of per year and all category--%>
        function showCategoryGridChart() {
           //Fetch the list of selected vessel
            ...
            Object.SubType = "Death";             //Pass sub type
...
<script type="text/javascript">
    function showCategoryChart_OnSuccess(data, status, jqXHR) {         //Success method to display line chart
        ...
        var settings = {
            ...
            title: 'Incidents with Death - Per Vessel',
            description: "",
...
<script type="text/javascript">
    ...
    function showInjuryPieChart() {
        ...
        Object1.SubType = "Death";             //Pass sub type
...
<script type="text/javascript">
    function showInjuryPieChart_OnSuccess(data, status, jqXHR) {         //Success method to display PIE chart
        ...
        var settings = {
            title: "Incidents with Death - By Category, All Vessels",
            description: "",
            enableAnimations: true,
            showLegend: true,
   ...
   <div style="height: 5px;"></div>
    ...
    <ul class="tabs">
        <li>
            ...
            <label for="tab1">Incidents with Death - Yearly</label>
            <div id="tab-content1" class="tab-content animated fadeIn">
                    ...
                    <div class="body-devide">
                        <ul>
                            <li>
                                <div id="jqxCategoryChart" style="width:100%; height: 300px; float: left; visibility:hidden; ">
                            </div> 
                            </li>
                            <li>&nbsp;</li>
                            <li>
        ...
        <li>
            ...
            <label for="tab2">Incidents with Death - by Category</label>
                ...
                <table border="0" width="100%">
                    ...
                    <div>
                        ...
                        <div style="overflow:auto;">
                            <div id="jqxInjuryPieChart" style="width: 600px; height: 400px; float: left; vertical-align:top; overflow-y: hidden;">
                            </div>                            
                        </div>
                    </div>
            </div>

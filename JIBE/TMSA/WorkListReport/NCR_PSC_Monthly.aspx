<%@ Page  Title="PSC NCR Month Wise" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="NCR_PSC_Monthly.aspx.cs" Inherits="TMSA_WorklistReport_NCR_PSC_Monthly" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script src="../../Scripts/jquery.tools.min.js" tjiype="text/javascript"></script>
    <script src="../../Scripts/jquery-ui.min.js" type="text/javascript"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="page-title">PSC NCR Month Wise</div>

<%@ Page Title="Incidents - Personnel" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="Incident.aspx.cs" Inherits="TMSA_WorklistReport_Incident" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <style type="text/css">
        ...
        .body-devide ul li:nth-of-type(1)
        {
            width: 47.5%;
        }
        .body-devide ul li:nth-of-type(2)
        {
            width: 5%;
        }
        .body-devide ul li:nth-of-type(3)
        {
            width: 47.5%;
        }
    ...
    <script type="text/javascript">
        function showCategoryChart_OnSuccess(data, status, jqXHR) {         //Success method to display line chart
            ...
            var settings = {
                ...
                title: 'Incidents with Personnel - By Category, All Vessels',
                description: "",
...
<%-- Method to bind Incident count to Gridview on the basis of per year and all category--%>
    ...
    <script type="text/javascript">
        function showVesselChart_OnSuccess(data, status, jqXHR) {         //Success method to display line chart
            ...
            var settings = {
                borderLineColor: 'white',
                title: 'Incidents with Personnel - Per Vessel',
                description: "",
                enableAnimations: true,
                showLegend: true,
                padding: { left: 20, top: 0, right: 50, bottom: 5 },
    ...
    <div class="tabcontent" id="divTab">
        <ul class="tabs">
            <li>
                ...
                <label for="tab1">
                    Incidents with Personnel Category - Yearly</label>
            ...
            <li>
                ...
                <label for="tab2">
                    Incidents with Personnel Category - Per Year</label>

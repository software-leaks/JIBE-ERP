<%@ Page Title="Incidents with Injury" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Incident_With_Injury.aspx.cs" Inherits="TMSA_WorklistReport_Incident_With_Injury" %>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        //        $('#jqxYear').bind('checkChange', function (event) {         
        //        SelectDeselect("#jqxYear");
        //        });

        //    $('#jqxVessel').bind('checkChange', function (event) {      
        ...
        //        $('#jqxVesselTab2').bind('checkChange', function (event) {
...
<script type="text/javascript"><%-- Method to bind Incident count to Gridview on the basis of per year and all category--%>
        function showCategoryGridChart() {
           //Fetch the list of selected vessel
            ...
            Object.SubType = "Injury";             //Pass sub type

            url = "../../KPIService.svc/GetCategoryInjuryIncidentCount";
...
<script type="text/javascript">
    function showCategoryChart_OnSuccess(data, status, jqXHR) {         //Success method to display line chart
        ...
        var settings = {
            ...
            title: 'Incidents with Injury - By Category, All Vessels',
            description: "",
...
<script type="text/javascript">
    function showVesselChart_OnSuccess(data, status, jqXHR) {         //Success method to display line chart
        ...
        var settings = {
            borderLineColor: 'white',
            title: 'Incidents with Injury - Per Vessel',
            description: "",
            enableAnimations: true,
            showLegend: true,
            padding: { left: 20, top: 0, right: 50, bottom: 5 },
...
<script type="text/javascript">
    ...
    function showInjuryPieChart() {
        ...
        Object1.SubType = "Injury";             //Pass sub type



        url = "../../KPIService.svc/GetInjuryIncidentCountForPieChart";
        $.ajax({
            type: "POST",
            url: url,
            ...
            processdata: true,
            async: false,
            success: showInjuryPieChart_OnSuccess,
            error: function () {
...
<script type="text/javascript">
    function showInjuryPieChart_OnSuccess(data, status, jqXHR) {         //Success method to display PIE chart
        var source =
            {
                datatype: "json",
                datafields: [
        ...
        $('#jqxInjuryPieChart').jqxChart(settings);
   ...
   <div style="height: 5px;"></div>
    ...
    <ul class="tabs">
        <li>
            ...
            <label for="tab1">Incidents with Injury - Yealy</label>
            <div id="tab-content1" class="tab-content animated fadeIn">
                    <table border="0" width="100%">
                     ...
                     <div class="body-devide">
                        <ul>
                            <li>
                                <div id="jqxVesselChart" style="width:100%; height: 300px; float: left; ">
                            </div> 
                            </li>
                            <li>&nbsp; </li>
                            <li>
                    ...
                    <div class="body-devide">
                        <ul>
                            <li>
                                <div id="jqxCategoryChart" style="width:100%;height: 300px; float: left; ">
                            </div> 
                            </li>
                            <li>&nbsp; </li>
                            <li>
        ...
        <li>
            ...
            <label for="tab2">Incidents with Injury - by Category</label>

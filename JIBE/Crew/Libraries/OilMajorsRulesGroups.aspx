<%@ Page Title="Oil Majors Rule Groups" Language="C#" MasterPageFile="~/Site.master"
    AutoEventWireup="true" CodeFile="OilMajorsRulesGroups.aspx.cs" Inherits="Crew_Libraries_OilMajorsRuleGroup" %>
                ...
                <asp:UpdatePanel ID="UpdUserType" runat="server">
                    <ContentTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" style="width: 5%">
                                            <asp:Image ImageUrl="~/Images/Add-icon.png" ID="ImgAdd" runat="server" Style="cursor: pointer;"
                                                ToolTip="Add new rule group" ClientIDMode="Static" />
                                        </td>
                                        <td style="width: 5%">
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="gvOilMajorsRuleGroup" runat="server" EmptyDataText="NO RECORDS FOUND"
                                    AutoGenerateColumns="False" OnRowDataBound="gvOilMajorsRuleGroup_RowDataBound"
                                    DataKeyNames="ID" CellPadding="0" CellSpacing="2" Width="100%" GridLines="both"
                                    OnSorting="gvOilMajorsRuleGroup_Sorting" AllowSorting="true" CssClass="gridmain-css">
                                        ...
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lblReasonHeader" Style="margin-left: 2px;" runat="server" CommandName="Sort"
                                                    CommandArgument="Group_Name" ForeColor="Black">Group</asp:LinkButton>
                                                <img id="Group_Name" runat="server" visible="false" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblGroupName" Text='<%#Eval("Group_Name")%>' option='<%#Eval("Type") %>'
                                                    rel='<%#Eval("ID")%>' runat="server" Style="color: Black; margin-left: 5px;" />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            ...
                                            <ItemTemplate>
                                                <asp:Image ID="Edit" CssClass="edit" ImageUrl="~/Images/Edit.gif" ForeColor="Black"
                                                    ToolTip="Edit" runat="server" Height="16px" Width="16px" rel='<%#Eval("ID")%>' option='<%#Eval("Type") %>'
                                                ...
                                                <asp:Image ID="imgRecordInfo" ImageAlign="AbsMiddle" ImageUrl="~/Images/RecordInformation.png"
                                                    Height="16px" Width="16px"  Style="vertical-align: top; cursor: pointer;" runat="server" onclick='<%# "Get_Record_Information(&#39;CRW_LIB_CM_RuleGroup&#39;,&#39;ID="+Eval("ID").ToString()+"&#39;,event,this)" %>' />
                                            </ItemTemplate>
                                ...
                                <uc1:ucCustomPager ID="ucCustomPagerItems" runat="server" PageSize="30" OnBindDataItem="BindOilMajorsRuleGroup" />
                            ...
                            <table width="100%" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 25%">
                                        <asp:TextBox ID="txtGroupName" ClientIDMode="Static" CssClass="txtInput" MaxLength="200"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("body").on("click", ".edit", function () {
                ...
                $("#txtGroupName").val($("span[rel='" + Rel + "']").text());
                $("#drpGroupType").val(parseInt($(this).attr("option")));
                showModal('divadd', false);
                $("#divadd_dvModalPopupTitle").text("Edit Group");
            });
            ...
            $("body").on("click", "#ImgAdd", function () {
                if (this.id == "ImgAdd") {
                    ...
                    $("#drpGroupType").val(1);
                    showModal('divadd', false);
                    $("#divadd_dvModalPopupTitle").text("Add New Group");
                }
                else {
                    $("#hdnOilMajorID").val(parseInt($(this).attr("rel")));
            ...
            $("body").on("click", "#btnsave", function () {
                if ($.trim($("#txtGroupName").val()) == "") {
                    $("#txtGroupName").val($.trim($("#txtGroupName").val()));
                    $("#txtGroupName").focus();

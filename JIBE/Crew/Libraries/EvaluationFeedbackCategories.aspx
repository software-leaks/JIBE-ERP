<%@ Page Title="Evaluation Feedback Category" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EvaluationFeedbackCategories.aspx.cs" Inherits="Crew_Libraries_Crew_EvaluationFeedbackCategories" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ctl00_MainContent_txtRankcategory").value.trim() == "") {
                alert("Please enter Evaluation Feedback category.");
                    ...
                    <ContentTemplate>
                        <div style="padding-top: 5px; padding-bottom: 5px; height: 40px; width: 100%">
                            <table width="100%" cellpadding="4" cellspacing="4">
                                <tr>
                                    ...
                                    <td align="center" style="width: 5%">
                                        <asp:ImageButton ID="ImgAdd" runat="server" ToolTip="Add New Feedback Category" OnClick="ImgAdd_Click"
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="gvRankCategory" runat="server" EmptyDataText="NO RECORDS FOUND" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Category">
                                            ...
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lblCategoryName" runat="server" Text='<%#Eval("Category")%>' Style="color: Black"
                                ...
                                <uc1:ucCustomPager ID="ucCustomPagerItems" runat="server" PageSize="30" OnBindDataItem="BindEvaluationFeedbackCategories" />
                            ...
                            <table width="100%" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width:25%">
                                        <asp:TextBox ID="txtRankcategory" CssClass="txtInput" MaxLength="100" Width="90%" runat="server"></asp:TextBox>
                                    </td>
                                </tr>

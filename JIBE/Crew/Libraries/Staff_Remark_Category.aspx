<%@ Page Title="Staff Remark Category" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="Staff_Remark_Category.aspx.cs" Inherits="Staff_Remark_Category" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ctl00_MainContent_txtcategory").value.trim() == "") {
                alert("Please enter Remark category.");
                document.getElementById("ctl00_MainContent_txtcategory").focus();
                return false;
            }
                ...
                <asp:UpdatePanel ID="UpdUserType" runat="server">
                    <ContentTemplate>
                        <div style="padding-top: 5px; padding-bottom: 5px; height: 40px; width: 100%">
                            <table width="100%" cellpadding="4" cellspacing="4">
                                <tr>
                                    ...
                                    <td align="center" style="width: 5%">
                                        <asp:ImageButton ID="ImgAdd" runat="server" ToolTip="Add New Remark Category" OnClick="ImgAdd_Click"
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="gvStaffRemarkCategory" runat="server" EmptyDataText="NO RECORDS FOUND"
                                    AutoGenerateColumns="False" OnRowDataBound="gvStaffRemarkCategory_RowDataBound"
                                    DataKeyNames="ID" CellPadding="1" CellSpacing="0" Width="100%" GridLines="both"
                                    OnSorting="gvStaffRemarkCategory_Sorting" AllowSorting="true" CssClas="gridmain-css">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Category">
                                            <HeaderTemplate>
                                                <asp:LinkButton ID="lblCategoryNameHeader" runat="server" CommandName="Sort" CommandArgument="Category"
                                                    ForeColor="Black">Category&nbsp;</asp:LinkButton>
                                                <img id="Category" runat="server" visible="false" />
                                            </HeaderTemplate>
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lblCategoryName" runat="server" Text='<%#Eval("Category")%>'
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Image ID="imgRecordInfo" ImageAlign="AbsMiddle" ImageUrl="~/Images/RecordInformation.png"
                                                                Height="16px" Width="16px" runat="server" onclick='<%# "Get_Record_Information(&#39;CRW_LIB_STAFFREMARK_CATEGORY&#39;,&#39;ID="+Eval("ID").ToString()+"&#39;,event,this)" %>' />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                ...
                                <uc1:ucCustomPager ID="ucCustomPagerItems" runat="server" PageSize="30" OnBindDataItem="BindRemarkCategory" />
                            ...
                            <table width="100%" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 25%">
                                        <asp:TextBox ID="txtcategory" CssClass="txtInput" MaxLength="100" Width="90%" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" style="font-size: 11px; text-align: center;">
                                        ...
                                        <asp:TextBox ID="txtcategoryID" runat="server" Visible="false" Width="1px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">

<%@ Page Title="Sign Off Reasons" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" 
    CodeFile="Signoff_Reason.aspx.cs" Inherits="Signoff_Reason" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function validation() {
            ...
            if (document.getElementById("ctl00_MainContent_txtsingoffReason").value.trim() == "") {
                alert("Please enter signoff reason.");
                document.getElementById("ctl00_MainContent_txtsingoffReason").focus();
                return false;
            }
                ...
                <asp:UpdatePanel ID="UpdUserType" runat="server">
                    <ContentTemplate>
                        <div style="padding-top: 5px; padding-bottom: 5px; height: 40px; width: 100%">
                            <table width="100%" cellpadding="4" cellspacing="4">
                                <tr>
                                    ...
                                    <td align="center" style="width: 5%">
                                        <asp:ImageButton ID="ImgAdd" runat="server" ToolTip="Add New Reason" OnClick="ImgAdd_Click"
                        ...
                        <div style="margin-left: auto; margin-right: auto; text-align: center;">
                            <div>
                                <asp:GridView ID="gvSnReason" runat="server" EmptyDataText="NO RECORDS FOUND" AutoGenerateColumns="False"
                                    OnRowDataBound="gvSnReason_RowDataBound" DataKeyNames="ID" CellPadding="1" CellSpacing="0"
                                    Width="100%" GridLines="both" OnSorting="gvSnReason_Sorting" AllowSorting="true" CssClass="gridmain-css">
                                ...
                                <HeaderStyle CssClass="HeaderStyle-css" Height="35px" />
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Reason" >
                                            <HeaderTemplate >
                                                <asp:LinkButton ID="lblReasonHeader" runat="server" CommandName="Sort" CommandArgument="Reason"
                                                    ForeColor="Black">Sign-off Reason&nbsp;</asp:LinkButton>
                                                <img id="Reason" runat="server" visible="false" />
                                            </HeaderTemplate>
                                            <ItemTemplate  >
                                                <asp:LinkButton ID="lblReason" runat="server" Text='<%#Eval("Reason")%>' Style="color: Black"
                                        ...
                                        <asp:TemplateField HeaderText="Default Joining Type">                                           
                                            <ItemTemplate>
                                                 <asp:Label ID="lblJoiningType" runat="server" Text='<%#Eval("Joining_Type")%>' Style="color: Black" ></asp:Label>
                                            </ItemTemplate>
                                             <ItemStyle Wrap="true" HorizontalAlign="Left" Width="200px" CssClass="PMSGridItemStyle-css">
                                            </ItemStyle>
                                         </asp:TemplateField>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Image ID="imgRecordInfo" ImageAlign="AbsMiddle" ImageUrl="~/Images/RecordInformation.png"
                                                                Height="16px" Width="16px" runat="server" onclick='<%# "Get_Record_Information(&#39;CRW_LIB_SIGNOFF_REASON&#39;,&#39;ID="+Eval("ID").ToString()+"&#39;,event,this)" %>' />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </ItemTemplate>
                                ...
                                <uc1:ucCustomPager ID="ucCustomPagerItems" runat="server" PageSize="30" OnBindDataItem="BindSignReason" />
                            ...
                            <table width="100%" cellpadding="2" cellspacing="2">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="width: 25%">
                                        <asp:TextBox ID="txtsingoffReason" CssClass="txtInput" MaxLength="100" Width="90%"
                                            runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr >
                                            <td align="left" style="width: 15%">
                                                Default Joining Type: &nbsp;:&nbsp;
                                            </td>
                                ...
                                <tr>
                                    <td colspan="3" style="font-size: 11px; text-align: center; background-color: #d8d8d8;">
                                        ...
                                        <asp:TextBox ID="txtsingoffReasonID" runat="server" Visible="false" Width="1px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">

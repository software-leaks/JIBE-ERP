...
public partial class Signoff_Reason : System.Web.UI.Page
{
    ...
    public void BindSignReason()
    {
        ...
        DataTable dt = objBLL.SignoffReason_Search(txtfilter.Text != "" ? txtfilter.Text : null, sortbycoloumn, sortdirection
    ...
    protected void ImgAdd_Click(object sender, EventArgs e)
    {
        ...
        OperationMode = "Add Signoff Reason";
    ...
    protected void ClearField()
    {
        ...
        txtsingoffReasonID.Text = "";
        txtsingoffReason.Text = "";
    }
    ...
    protected void onUpdate(object source, CommandEventArgs e)
    {
        ...
        OperationMode = "Edit Signoff Reason";

        DataTable dt = new DataTable();
        dt = objBLL.Get_SignoffReason_List(Convert.ToInt32(e.CommandArgument.ToString()));


        txtsingoffReasonID.Text = dt.Rows[0]["ID"].ToString();
        txtsingoffReason.Text = dt.Rows[0]["Reason"].ToString();

        ddlJoinType.SelectedValue = dt.Rows[0]["JoiningTypeId"].ToString();


        string InfoDiv = "Get_Record_Information_Details('CRW_LIB_SIGNOFF_REASON','ID=" + txtsingoffReasonID.Text + "')";
    ...
    protected void ImgExpExcel_Click(object sender, EventArgs e)
    {
        ...
        string[] HeaderCaptions = { "Reason" };
        string[] DataColumnsName = { "Reason" };

        GridViewExportUtil.ShowExcel(dt, HeaderCaptions, DataColumnsName, "SignoffReason", "Crew Signoff Reason", "");

    }

    protected void gvSnReason_RowDataBound(object sender, GridViewRowEventArgs e)
    {
    ...
    protected void gvSnReason_Sorting(object sender, GridViewSortEventArgs se)
    {

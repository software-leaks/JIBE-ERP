<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewComplaints.aspx.cs" Inherits="Crew_CrewComplaints" EnableViewState="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CREW COMPLAINTS</title>
</head>
<body>
                        ...
                        <asp:Repeater ID="rptComplaintsToMe" runat="server">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Repeater runat="server" ID="rptLog" DataSource='<%# ((System.Data.DataRowView) Container.DataItem).Row.GetChildRows("EscLog") %>'>
                                    <ItemTemplate>
                                        <tr class='<%# (((System.Data.DataRow)Container.DataItem)["Escalated_To"].ToString()==GetCrewID().ToString())?"required":"not-selected"%>'  style="text-align:center;">
                                            <td>
                        ...
                        <asp:Repeater ID="rptMyComplaints" runat="server">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Repeater runat="server" ID="rptLog" DataSource='<%# ((System.Data.DataRowView) Container.DataItem).Row.GetChildRows("MyLog") %>'>
                                    <ItemTemplate>
                                        <tr class='<%# (((System.Data.DataRow)Container.DataItem)["Escalated_By"].ToString()==GetCrewID().ToString())?"required":"not-selected"%>' style="text-align:center;">
                                            <td>
                                                <%# ((System.Data.DataRow)Container.DataItem)["ESCALATED_ON"]%>
                                            </td>
                                            <td>

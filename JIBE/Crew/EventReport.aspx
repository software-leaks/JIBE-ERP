<%@ Page Title="Event Index" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeFile="EventReport.aspx.cs" Inherits="Crew_EventReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function toggleAll(event) {
            ...
            if (check.lastIndexOf("plus.png") != -1) {
                oMe.src = "../images/Minus.png"
                $('.dbx-toggle').attr('src', '../images/Minus.png');
                $('.toggle-content').show();
            }
            else {
                oMe.src = "../images/Plus.png"
                $('.dbx-toggle').attr('src', '../images/Plus.png');
                $('.toggle-content').hide();
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="dvpage-title" class="page-title">
        <table style="width: 100%">
            <tr>
                <td style="width: 33%">
                </td>
                <td style="width: 34%; text-align: center;">
                    <asp:Label ID="lblPageTitle" runat="server" Text="Event Index"></asp:Label>
                </td>
    ...
    <div id="dvpage-content" class="page-content-main">
                    ...
                    <table style="color: Black; font-weight: bold;">
                        <tr>
                            ...
                            <td style="width: 200px;">
                                <uc:PortList ID="ctlSignOnPort" runat="server" SelectedValue='<%# Bind("Joining_Port") %>'
                                    OnSelectedIndexChanged="Bind_ChangeEvent" />
                            </td>
                            <td style="width: 100px;">
                                From
                            </td>
                            <td style="width: 150px;">
                                <asp:TextBox ID="txtEventFromDate" runat="server" Width="100px"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="txtEventFromDate">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlEventStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlEventStatus_SelectedIndexChanged"
                                    Style="width: 148px;">
                            ...
                            <td>
                                <asp:TextBox ID="txtEventToDate" runat="server" Width="100px"></asp:TextBox>
                                <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txtEventToDate">
                                </ajaxToolkit:CalendarExtender>
                            </td>
                            <td>
                            </td>
                            <td>
                                <asp:Button ID="btnSearch" runat="server"  ToolTip="Search" Text=" Search " OnClick="btnSearch_Click">
                                </asp:Button>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:GridView ID="gvCrewChangeEvent" runat="server" AutoGenerateColumns="False" BorderColor="#336666"
                                    CellPadding="1" Font-Size="11px" GridLines="Horizontal"
                                    Width="100%" DataKeyNames="PKID" AllowSorting="True" OnRowDataBound="gvCrewChangeEvent_RowDataBound"
                                    OnRowDeleting="gvCrewChangeEvent_RowDeleting" CssClass="gridmain-css">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ShowHeader="False" ItemStyle-Width="20px">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnDelete" ToolTip="Delete"  runat="server" ImageUrl="~/images/delete.png" CausesValidation="False"
        ...
        <asp:UpdatePanel ID="UpdatePanelAdditionalCrew" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <asp:Panel ID="pnlAdditionalCrew" runat="server" Visible="false">
                    <div id="Div1" style="background-color: #BDBDBD; border: 1px solid #585858;">
                        <table style="width: 100%">
                            <tr>
                                                        ...
                                                        <td style="vertical-align: top;">
                                                            <div class="grid-container">
                                                                <asp:GridView ID="gvCrewList_OffSigner" runat="server" AutoGenerateColumns="False"
                                                                    BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="0px"
                                                                    CellPadding="2" AllowPaging="false" PageSize="15" GridLines="Horizontal" Width="100%"
                                                                    DataKeyNames="ID" AllowSorting="true" Font-Size="11px" CssClass="GridCSS">
                                                                    <AlternatingRowStyle CssClass="AlternatingRowStyle-css" />
                                                                    <RowStyle CssClass="RowStyle-css" />
                                            ...
                                            <td style="text-align: left; background-color: #fff; vertical-align: top;">
                                                <table style="width: 100%">
                                                    <tr>
                                                        <td>
                                                            Search:
                                                            <asp:TextBox ID="txtSearchCrew_OnSigners" runat="server" AutoPostBack="true" Width="200px"
                                                                OnTextChanged="txtSearchCrew_OnSigners_TextChanged"></asp:TextBox>
                                                        ...
                                                        <td style="vertical-align: top;">
                                                            <div class="grid-container">
                                                                <asp:GridView ID="gvCrewList_OnSigner" runat="server" AutoGenerateColumns="False"
                                                                    BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="0px"
                                                                    CellPadding="2" AllowPaging="false" PageSize="15" GridLines="Horizontal" Width="100%"
                                                                    DataKeyNames="ID" AllowSorting="false" Font-Size="11px" CssClass="GridCSS" OnRowDataBound="gvCrewList_OnSigner_RowDataBound">
                                                                    <AlternatingRowStyle CssClass="AlternatingRowStyle-css" />
                                                                    <RowStyle CssClass="RowStyle-css" />
                                                                    <HeaderStyle CssClass="HeaderStyle-css" Height="35px" />
                                                                    <Columns>
                        ...
                        <tr>
                            <td>
                                <table cellspacing="1" cellpadding="1" style="border: 1px solid #610B5E; width: 100%;"
                                    border="0">
                                    <tr>
                                        <th style="background-color: #336666; color: White; width: 1%">
                                            <img src="../Images/Plus.png" alt="Expand/Collapse All" onclick="toggleAll(event)" />
                                        </th>
                                        <th colspan="7" style="background-color: #336666; color: White; width: 49.5%">
                                            Off-Signers
                                        </th>
                                        <th>
                                        </th>
                                        ...
                                        <ItemTemplate>
                                            <tr style="background-color: #E0F8F7; color: Black;">
                                                <td style="text-align: center; width: 20px;">
                                                    <img src="../Images/Plus.png" alt="" class="dbx-toggle" child='<%# Eval("PKID")%>'
                                                        onclick="outliner(event)" />
                                                </td>
                                                ...
                                                <td colspan="3">
                                                <asp:Label ID="lblCreatedBy" runat="server" Text='<%# "&nbsp;&nbsp;Created By: " + Eval("CreatedBy").ToString() + " on:" + UDFLib.ConvertUserDateFormat(Convert.ToString(Eval("Date_Of_Creatation")))%>'></asp:Label>
                                                </td>
                                                <td colspan="3">
                                                    <asp:Label ID="Label1" runat="server" Text='<%# "&nbsp;&nbsp;Closed By: " + Eval("ClosedBy").ToString() + " on:" + UDFLib.ConvertUserDateFormat(Convert.ToString(Eval("DateClosed")))%>'
                                                        Visible='<%# Eval("Event_Status").ToString() =="0"? true:false%>'></asp:Label>
                                                </td>
                                                <td colspan="3" style="text-align: right">
                                                    <asp:ImageButton ID="ImgFlightRequest" runat="server" ImageUrl="~/Travel/images/NewFlightRequest.png"
                                                        CommandName="NewFlightRequest" CommandArgument='<%#  Eval("PKID").ToString()+"&Event_Date="+Eval("Event_Date", "{0:dd/MM/yyyy}").ToString()+"&Port_Name="+Eval("Port_Name").ToString()%>' />
                                                </td>
                                            </tr>
                                            <tr style="display: none;" class='<%#  Eval("PKID")%> toggle-content'>
                                                <td colspan="16" style="text-align: right">
                                                    <div style="text-align: right">
                                                        ONBD Count = <span class='<%# Eval("SEQ_Class")%>'>
                                                            <%# Eval("ONBD_Count")%>
                                                        </span>, SEQ = <span style='font-weight: bold;'>
                                                            <%# Eval("SEQ")%>
                                                            <%# Eval("SEQ_Remarks")%>
                                                        </span>
                                                    </div>
                                            ...
                                            <tr style="background-color: #E0E0F8; color: Black; border-bottom: 1px solid gray;">
                                                ...
                                                <td colspan="7" style="text-align: right">
                                                    <asp:LinkButton ID="btnNotifyMO" runat="server" Text="Notify M/O" CommandName="NotifyManningAgent"
                                                        Visible='<%#objUA.Add == 0?false:true%>' CssClass="linkbutton" CommandArgument='<%# Eval("PKID")%>'>
                                                    </asp:LinkButton>
                                                    ...
                                                    <asp:LinkButton ID="btnNotifyFinalCrewChange" runat="server" Text="Final Crew Change"
                                                        Visible='<%#objUA.Add == 0?false:true%>' CommandName="FinalPlan" CssClass="linkbutton"
                                            ...
                                            <tr style="background-color: #A9F5D0; color: Black; display: none;" class='<%#  Eval("PKID")%> toggle-content'>
                                            ...
                                            <asp:Repeater runat="server" ID="rpt2" OnItemCommand="rpt2_ItemCommand" DataSource='<%# ((System.Data.DataRowView) Container.DataItem).Row.GetChildRows("EventMembers") %>'
                                                ...
                                                <ItemTemplate>
                                                    <tr style="background-color: #E0F8F7; color: Black; border-bottom: 1px solid gray;
                                                        display: none;" class='<%# ((System.Data.DataRow) Container.DataItem)["PKID"]%> toggle-content'>
        ...
        <div id="dvViewSelectedCrew" title="Selected Staffs" style="width: 1024px;">
            <asp:UpdatePanel ID="UpdatePanel_AdditionalSelected" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:Panel ID="pnlViewSelectedCrew" runat="server" Visible="false">
                                ...
                                <tr>
                                    <td style="vertical-align: top; background-color: White; border: 1px solid gray;"
                                        ...
                                        <asp:GridView ID="gvSelectedOffSigners" runat="server" AutoGenerateColumns="False"
                                            ...
                                            Font-Size="11px" CssClass="GridCSS">
                                                <AlternatingRowStyle CssClass="AlternatingRowStyle-css" />
                                                <RowStyle CssClass="RowStyle-css" />
                                              <HeaderStyle CssClass="HeaderStyle-css" Height="35px" />
                                            <Columns>
                                    ...
                                    <td style="vertical-align: top; background-color: White; border: 1px solid gray;"
                                        ...
                                        <asp:GridView ID="gvSelectedONSigners" runat="server" AutoGenerateColumns="False"
                                            ...
                                            CellPadding="2" AllowPaging="false" PageSize="15" GridLines="Horizontal" Width="100%"
                                            DataKeyNames="ID" AllowSorting="true" Font-Size="11px" CssClass="GridCSS" OnRowDataBound="gvSelectedONSigners_RowDataBound">
                                                <AlternatingRowStyle CssClass="AlternatingRowStyle-css" />
                                             <RowStyle CssClass="RowStyle-css" />
                                                 <HeaderStyle CssClass="HeaderStyle-css" Height="35px" />
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Joining Rank" HeaderStyle-HorizontalAlign="Left">
                                                    <ItemTemplate>
                                                        <asp:DropDownList ID="ddlRank" runat="server" Text='<%# Eval("Rank_ID") %>' DataSourceID="objDS2" AutoPostBack="true"
                                                            DataTextField="Rank_Short_Name" DataValueField="ID" AppendDataBoundItems="true"   onselectedindexchanged="ddlRank_SelectedIndexChanged" 
                                                            Width="100px">

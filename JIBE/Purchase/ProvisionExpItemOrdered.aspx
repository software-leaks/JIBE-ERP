<%@ Page Title="Most Expensive Items Ordered" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProvisionExpItemOrdered.aspx.cs" Inherits="Purchase_ProvisionExpItemOrdered" %>
...
<asp:UpdateProgress ID="upUpdateProgress" runat="server">
        ...
        <div style="border: 1px solid #cccccc; font-family: Tahoma; font-size: 12px; width: 1000px;
            ...
            <div style="font-size: 24px; background-color: #5588BB; width: 1000px; color: White;
                text-align: center;">
                <b>Expensive Item Ordered List </b>
            </div>

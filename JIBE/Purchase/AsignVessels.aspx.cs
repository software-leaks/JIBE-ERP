...
public partial class AsignVessels : System.Web.UI.Page
{
    ...
    protected void ImgAssignLocation_Click(object sender, ImageClickEventArgs e)
    {
        ...
        try
        {
            ...
            using ( BLL_PURC_Purchase  objTechService = new  BLL_PURC_Purchase ())
            {
                ...
                cell = DDLVessel.SelectedValue.ToString();   
                    ...
                    foreach (GridDataItem item in grdunAssignLocation.SelectedItems)
                    {
                        ...
                        objAssignVesselDataDO.CurrentUser = Session["userid"].ToString();
            ...
            using ( BLL_PURC_Purchase  objTechService = new  BLL_PURC_Purchase ())
            {
                ...
                //{
                   ...
                   // cell1 = row1["Vessel_code"].Text;
                    ...
                    cell1 = DDLVessel.SelectedValue.ToString();    

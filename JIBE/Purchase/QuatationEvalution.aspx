<%@ Page Title="Quotation Comparision " Language="C#" MasterPageFile="~/Site.master" EnableEventValidation="false"
    AutoEventWireup="true" CodeFile="QuatationEvalution.aspx.cs" Inherits="Purchase_Quotation_Evaluation_Gridview" %>
...
//            var ReqnCode = document.getElementById('ctl00_MainContent_hdReqnCode').value;
//            var DocumentCode = document.getElementById('ctl00_MainContent_hdDocumentCode').value;
//            var VesselCode = document.getElementById('ctl00_MainContent_hdVesselCode').value;
//            var url = 'Approve_Purchase_Order.aspx?Requisitioncode=' + ReqnCode + '&Document_Code=' + DocumentCode + '&Vessel_Code=' + VesselCode;
//            OpenPopupWindowBtnID('Assign_budget_code_and_Approve', 'Assign budget code and Approve', url, 'popup', 520, 1100, null, null, false, false, true, null, 'ctl00_MainContent_btnFilter');
        }
    </script>
</asp:Content>
                                        ...
                                        <div id="divInfoQTN" onscroll="checkAvailableWidth()">
                                            <asp:GridView ID="rgdQuatationInfo" runat="server" OnRowDataBound="rgdQuatationInfo_ItemDataBound"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Order Unit">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbtnUnitsPKg" runat="server" OnClientClick="ShowUnitsPkg(id);return false;"
                    ...
                    <tr style="background-color: #CCCCCC; font-size: small; color: #FFFFFF;">
                        ...
                        <td>
                            ...
                            <asp:HiddenField ID="hdfquotation_codes_RowNum_compare" runat="server" />
                               <asp:HiddenField ID="hdReqnCode" runat="server" />
                            <asp:HiddenField ID="hdVesselCode"  runat="server" />

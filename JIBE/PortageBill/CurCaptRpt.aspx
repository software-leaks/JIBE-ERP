<%@ Page Title="Capt Cash (Un-Finalized)  Details" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CurCaptRpt.aspx.cs" Inherits="PortageBill_CurCaptRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="page-title" style="border: 1px solid #cccccc; height: 20px; vertical-align: bottom;
       ...
       Capt Cash (Un-Finalized) Details
    </div>
